...
import com.jstpay.jstpay.CaptureAePsModels;
import com.jstpay.jstpay.CaptureResponse;
import com.jstpay.jstpay.CardnumberORUID;
import com.jstpay.jstpay.DataAttributes;
import com.jstpay.jstpay.EncrptionMethodV2;
import com.jstpay.jstpay.HashGenerator;
import com.jstpay.jstpay.R;
   ...
   public void aadharscan(){
    ...
    public void RdserviceResponse() {
       ...
       /* WifiManager manager = (WifiManager) getApplicationContext().getSystemService(Context.WIFI_SERVICE);
        ...
        Log.d("Tag6","insdie1");
        com.jstpay.jstpay.EncrptionMethodV2 encrptionMethodV2 = new com.jstpay.jstpay.EncrptionMethodV2();
        ...
        try {
            encryptData = com.jstpay.jstpay.EncrptionMethodV2.encryptUsingSessionKey(skey, requestJson.toString().getBytes());
        ...
        com.jstpay.jstpay.HashGenerator generator = new HashGenerator();
