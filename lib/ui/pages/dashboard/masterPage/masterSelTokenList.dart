...
class MasterSelTokenList extends StatefulWidget {
  const MasterSelTokenList({Key key}) : super(key: key);

  @override
  _MasterSelTokenListState createState() => _MasterSelTokenListState();
}

class _MasterSelTokenListState extends State<MasterSelTokenList> {
  @override
