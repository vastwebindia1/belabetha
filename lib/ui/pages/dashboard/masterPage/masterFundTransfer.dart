...
class MasterFundTransfer extends StatefulWidget {
  const MasterFundTransfer({Key key}) : super(key: key);

  @override
  _MasterFundTransferState createState() => _MasterFundTransferState();
}

class _MasterFundTransferState extends State<MasterFundTransfer> {
                  ...
                  itemBuilder: (context, index) {
                    return ListTile(
                      ...
                      onTap: () {
                        ...
                        setState(() {
                          dealerbank1 = masterBankname[index]["banknm"];
                          dealerbankacc = masterBankname[index]["acno"];
                  ...
                  itemBuilder: (context, index) {
                    return ListTile(
                      ...
                      onTap: () {
                        ...
                        setState(() {
                          dealerwallet1 = masterwallet[index]["walletname"];
                          dealerwalletno = masterwallet[index]["walletno"];
  ...
  Future<void> adminDealerBankList() async {
    ...
    String token = a;
    var url = new Uri.http("api.vastwebindia.com", "/api/data/ShowMasterBankList");
    ...
    if (response.statusCode == 200) {
      ...
      setState(() {
        masterBankname = distributerbank;
        masterwallet = distributerwallet;
  ...
  Future<void> fundTransferDealer(String alfa1,String mode2,String type2, String collection2,
    ...
    String token = a;
    var url = new Uri.http("api.vastwebindia.com", "/api/master/FundTransfer");
                                    ...
                                    child: TextButton(
                                      ...
                                      onPressed: (){
                                        ...
                                        setState(() {
                                          ...
                                          retailerAmount = dealer[index]["RemainAmt"].toString();
                                          retailerCredit = dealer[index]["currentcr"].toString();
                                      ...
                                      child: Container(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            Text(getTranslated(context, 'Current Amount') +" : " +dealer[index]["RemainAmt"].toString(),textAlign: TextAlign.left,style: TextStyle(color: PrimaryColor),),
  ...
  Future<void> generateUniqueId() async {
    ...
    var url = new Uri.http("api.vastwebindia.com", "/api/data/MD_to_DLM_Generate_Unique_ID");
    final http.Response response = await http.get(
      url,
      headers: {
        'Accept': 'application/json',
                      ...
                      children: [
                       ...
                       /* Container(
                          ...
                          child:InputTextField(
                            ...
                            label: getTranslated(context, 'Trans Pin'),
                            obscureText: false,
                            labelStyle: TextStyle(
                              color: PrimaryColor,
                            ),
                            ...
                            onPressed: () {
                              ...
                              if(paymentMode1 == "Cash"){
                                ...
                                fundTransferEncription(paymentMode1, collectionController.text,
                                    commentController.text,retailerId,"1234",trasactionId);
                                ...
                                fundTransferOnlineEncription(paymentMode1,dealerbank1,paymentType1,utrController.text,dealerbankacc, retailerId, "1234",trasactionId);

                              }else if (paymentMode1 == "Wallet") {

                                fundTransferWalletEncription(paymentMode1,dealerwallet1,dealerwalletno,transactioncontroller.text,commentController.text,retailerId, "1234",trasactionId);
  ...
  void fundTransferEncription(String mode,String collection, String comment,String userId,String pinNo,String transId) async{
    ...
    fundTransferDealer(alfa, mode1,type1,collection1,comment1,deposit1,utrno1,
  ...
  void fundTransferBackEncription(String mode,String subject2, String comment,String userId,String pinNo,String transId) async{
    ...
    fundTransferDealer(alfa, mode1,type1,subject,comment1,deposit1,utrno1,
        account1,walletno1,bank1,transaction1,subject,mdWallet,mdSettelment,
        mdCreditDetails,userId1,pinNo1,transId1,keyencoded,viencoded);
