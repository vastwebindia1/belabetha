...
import 'package:myapp/ui/pages/dashboard/drawerPages/masterProfile.dart';
...
class MyDrawerMaster extends StatefulWidget {
  final String firmname;

  const MyDrawerMaster({Key key, this.firmname}) : super(key: key);

  @override
  _MyDrawerMasterState createState() => _MyDrawerMasterState();
}
ScrollController scroll = ScrollController();

class _MyDrawerMasterState extends State<MyDrawerMaster> {

  String masterReferlcode = "";
  String masterDpPicture = "";
  ...
  void refrcode()async{
    ...
    masterReferlcode = prefs.getString("referlcode");
    setState(() {
      masterReferlcode;
  ...
  void masterDpPhoto()async{
    ...
    async {
      ...
      final prefs = await SharedPreferences.getInstance();
      masterDpPicture = prefs.getString('masterDpPhoto');
      setState(() {
        masterDpPicture;
      });
      blTest1 = false;
                          ...
                          child: TextButton(
                            ...
                            onPressed: (){
                              Navigator.push(context,
                                  MaterialPageRoute(builder: (_) => MasterProfile())
                              );
                            },
                            child: Container(
                                  ...
                                  Container(
                                    child: ClipRRect(
                                      ...
                                      child:blTest1 ? SizedBox(
                                        ...
                                        width: 50,
                                        fit: BoxFit.cover,
                                        image:masterDpPicture== "" ? NetworkImage("https://upload.wikimedia.org/wikipedia/commons/e/e0/Userimage.png",): NetworkImage(
                                            "https://test.vastwebindia.com/" + masterDpPicture,scale: 1),
                                      ),
                                    ),
