...
import 'dealerList.dart';
import 'masterCreateUser.dart';

class MasterUserTabs extends StatefulWidget {
  const MasterUserTabs({Key key}) : super(key: key);

  @override
  _MasterUserTabsState createState() => _MasterUserTabsState();
}

class _MasterUserTabsState extends State<MasterUserTabs> {
