...
class MasterFundTraReport extends StatefulWidget {
  const MasterFundTraReport({Key key}) : super(key: key);

  @override
  _MasterFundTraReportState createState() => _MasterFundTraReportState();
}

class _MasterFundTraReportState extends State<MasterFundTraReport> {
 ...
 DateTime selectedDate2 = DateTime.now();
  ...
  Future<void> dealerFundHistory( String dealer1 ,String from1 ,String to1,String retailer1 ) async {
    ...
    var url = new Uri.http("api.vastwebindia.com", "/api/master/Fund_transfer_history",
        {
          "distibutorid" : retailer1,
          "txt_frm_date" : from1,
          "txt_to_date" :to1,
        });
    final http.Response response = await http.get(
                            ...
                            children: [
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  borderRadius: BorderRadius.circular(3),
                                  boxShadow: [
                                    BoxShadow(color: PrimaryColor.withOpacity(0.2), spreadRadius: 3, blurRadius: 5, offset: Offset(0, 1),),
                                  ],
                                ),
                                child: Column(
                                  mainAxisAlignment: MainAxisAlignment.center,
                                  ...
                                  children: [
                                    Column(
                                      ...
                                      children: [
                                            ...
                                            Expanded(
                                              child: Column(
                                                ...
                                                children: [
                                                  ...
                                                  Text(delHistory[index]["DealerId"] == null ? "":delHistory[index]["DealerId"],style: TextStyle(fontSize: 12,fontWeight: FontWeight.bold),overflow: TextOverflow.clip,maxLines: 2,)
                                                ],
                                              ),
                                            ),
                                            Expanded(
                                        ...
                                        SizedBox(height: 1,child: Container(padding: EdgeInsets.only(top: 5,bottom: 5),color: PrimaryColor.withOpacity(0.3),),),
                                        Row(
                                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                          children: [
                                            Expanded(
