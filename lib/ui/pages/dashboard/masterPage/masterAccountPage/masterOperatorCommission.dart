...
class MasterOperatorCommission extends StatefulWidget {
  const MasterOperatorCommission({Key key}) : super(key: key);

  @override
  _MasterOperatorCommissionState createState() => _MasterOperatorCommissionState();
}

class _MasterOperatorCommissionState extends State<MasterOperatorCommission> {
  ...
  Future<void> masterOperatorCommision(String operator) async {
    final storage = new FlutterSecureStorage();
    var a = await storage.read(key: "accessToken");

    String token = a;
    var url =
    new Uri.http("api.vastwebindia.com", "/api/data/MasterOpertorByCommission",{
      "ddltype":operator,
    ...
    if (response.statusCode == 200) {
      ...
      if(receive == "Pancard"){
        ...
        for(var i = 0; i<data.length; i++){
          ...
          digitalToken = data[i]["TokenValueDigital"].toString();
          digitalCommision = data[i]["CommDigital"].toString();
          physicalToekn = data[i]["TokenValuePhysical"].toString();
          physivalCommision = data[i]["CommPhysical"].toString();
  ...
  void initState() {
    ...
    receive = "Prepaid";
    masterOperatorCommision(receive);
                                                      ...
                                                      children: [
                                                        ...
                                                        Container(
                                                          ...
                                                          child: Row(
                                                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                                            children: [
                                                              Text("1 To 1000",overflow: TextOverflow.ellipsis,
                                                                style: TextStyle(fontSize: 12,),
                                                              ),
                                                              Text("\u{20B9} " + operatorInfoList[index]["Comm_1_1000"].toString() == null ? "":  "\u{20B9} " + operatorInfoList[index]["Comm_1_1000"].toString(),
                                                                style: TextStyle(fontSize: 12,fontWeight: FontWeight.bold),),
                                                            ],
                                                          ),
                                                        ),
                                                        Container(
                                                          ...
                                                          child: Row(
                                                            ...
                                                            children: [
                                                              ...
                                                              Text("\u{20B9} " + operatorInfoList[index]["comm_1001_2000"].toString() == null ? "":  "\u{20B9} " + operatorInfoList[index]["comm_1001_2000"].toString(),
                                                                style: TextStyle(fontSize: 12,fontWeight: FontWeight.bold),),
                                                            ],
                                                          ),
                                                        ),
                                                        Container(
                                                          ...
                                                          child: Row(
                                                            ...
                                                            children: [
                                                              ...
                                                              Text("\u{20B9} " + operatorInfoList[index]["comm_2001_3000"].toString() == null ? "":  "\u{20B9} " + operatorInfoList[index]["comm_2001_3000"].toString(),
                                                                style: TextStyle(fontSize: 12,fontWeight: FontWeight.bold),),
                                                            ],
                                                          ),
                                                        ),
                                                        Container(
                                                          ...
                                                          child: Row(
                                                            ...
                                                            children: [
                                                              ...
                                                              Text("\u{20B9} " + operatorInfoList[index]["comm_3001_4000"].toString() == null ? "":  "\u{20B9} " + operatorInfoList[index]["comm_3001_4000"].toString(),
                                                                style: TextStyle(fontSize: 12,fontWeight: FontWeight.bold),),
                                                            ],
                                                          ),
                                                        ),
                                                        Container(
                                                          ...
                                                          child: Row(
                                                            ...
                                                            children: [
                                                              ...
                                                              Text("\u{20B9} " + operatorInfoList[index]["comm_4001_5000"].toString() == null ? "":  "\u{20B9} " + operatorInfoList[index]["comm_4001_5000"].toString(),
                                                                style: TextStyle(fontSize: 12,fontWeight: FontWeight.bold),),
                                                            ],
                                                          ),
                                                        ),
                                                        ...
                                                        children: [
                                                          Column(
                                                            ...
                                                            children: [
                                                              ...
                                                              Text(operatorInfoList[index]["cardname"].toString(),style: TextStyle(fontSize: 12,fontWeight: FontWeight.bold),),
                                                            ],
                                                          ),
                                                          Column(
                                                            crossAxisAlignment: CrossAxisAlignment.center,
                                                            children: [
                                                              ...
                                                              Text(operatorInfoList[index]["cardcategorytype"].toString(),style: TextStyle(fontSize: 12,fontWeight: FontWeight.bold),),
                                                            ],
                                                          ),
                                                          Column(
                                                            crossAxisAlignment: CrossAxisAlignment.end,
                                                            children: [
                                                              ...
                                                              Text(operatorInfoList[index]["cardtype"].toString(),style: TextStyle(fontSize: 12,fontWeight: FontWeight.bold),),
                                                            ],
                                                          ),
                                                        ],
                                                      )),
                                                                    ...
                                                                    Expanded(
                                                                        child: Container(
                                                                            ...
                                                                            child: Row(
                                                                              mainAxisAlignment: MainAxisAlignment.center,
                                                                              children: [
                                                                                Text(getTranslated(context, 'Min Value'),style: TextStyle(fontSize: 10,),),
                                                                              ],
                                                                            )
                                                                        )),
                                                                    Expanded(
                                                                        child: Container(
                                                                            ...
                                                                            child: Row(
                                                                              mainAxisAlignment: MainAxisAlignment.center,
                                                                              children: [
                                                                                Text(getTranslated(context, 'Max Value'),style: TextStyle(fontSize: 10,),),
                                                                              ],
                                                                            )
                                                                        )),
                                                                  ],
