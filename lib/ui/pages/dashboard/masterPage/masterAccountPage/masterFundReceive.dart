...
class MasterFundReceive extends StatefulWidget {
  const MasterFundReceive({Key key}) : super(key: key);

  @override
  _MasterFundReceiveState createState() => _MasterFundReceiveState();
}

class _MasterFundReceiveState extends State<MasterFundReceive> {
 ...
 DateTime selectedDate2 = DateTime.now();
  ...
  Future<void> masterFundReceiveAdmin( String frmDate, String toDate,) async {
    final storage = new FlutterSecureStorage();
    var a = await storage.read(key: "accessToken");

    String token = a;
    var url =
    new Uri.http("api.vastwebindia.com", "/api/master/BalanceReceive",{
  ...
  void initState() {
    ...
    masterFundReceiveAdmin(frmDate,toDate);
                                                  ...
                                                  Expanded(
                                                    child: Column(
                                                        ...
                                                        children: [
                                                          ...
                                                          Text (masterInfoReport[index]["SenderId"] == null ? "....." :masterInfoReport[index]["SenderId"],style: TextStyle(fontSize: 12,fontWeight: FontWeight.bold),),
                                                        ]),
                                                  ),
                                                  Expanded(
                                                    child: Column(
                                                        ...
                                                        children: [
                                                          ...
                                                          Text (masterInfoReport[index]["Date"] == null ? "0 0 0" :masterInfoReport[index]["Date"],style: TextStyle(fontSize: 12,fontWeight: FontWeight.bold,),),
                                                        ]),
                                                  ),
                                                  ...
                                                  child: Container(
                                                    ...
                                                    child: Column(
                                                      ...
                                                      children: [
                                                        ...
                                                        Text(
                                                          "\u{20B9} " + masterInfoReport[index]["OldBal"].toString() == null ? "":"\u{20B9} " + masterInfoReport[index]["OldBal"].toString(),
                                                  ...
                                                  child: Container(
                                                    ...
                                                    child: Column(
                                                      children: [
                                                        ...
                                                        Text("\u{20B9} " + masterInfoReport[index]["CurrentBal"].toString() == null ? "": "\u{20B9} " + masterInfoReport[index]["CurrentBal"].toString(),style: TextStyle(fontSize: 12,fontWeight: FontWeight.bold),textAlign: TextAlign.right,)
                                                      ],
                                                    ),
                                                  ),
                                                ),
                                                  ...
                                                  child: Container(
                                                    ...
                                                    child: Column(
                                                      ...
                                                      children: [
                                                        ...
                                                        Text("\u{20B9} " + masterInfoReport[index]["Amount"].toString() == null ? "": "\u{20B9} " + masterInfoReport[index]["Amount"].toString(),style: TextStyle(fontSize: 12,fontWeight: FontWeight.bold),textAlign: TextAlign.center,)
                                                      ],
                                                    ),
                                                  ),
                                                ),
                                                Expanded(
                                                  child: Container(
                                                    child: Column(
                                                      crossAxisAlignment: CrossAxisAlignment.end,
                                                      children: [
                                                        Text("Commision",style: TextStyle(fontSize: 10),),
                                                        Text(masterInfoReport[index]["Commission"].toString() == null ? "":  masterInfoReport[index]["Commission"].toString(),style: TextStyle(fontSize: 12,fontWeight: FontWeight.bold),textAlign: TextAlign.center,overflow: TextOverflow.ellipsis,)
                                                      ],
                                                    ),
                                                  ),
                                                ),
