...
class MasterIncomeReport extends StatefulWidget {
  const MasterIncomeReport({Key key}) : super(key: key);

  @override
  _MasterIncomeReportState createState() => _MasterIncomeReportState();
}

class _MasterIncomeReportState extends State<MasterIncomeReport> {
 ...
 DateTime selectedDate2 = DateTime.now();
  ...
  Future<void> masterIncomeHistory( String frmDate) async {
    final storage = new FlutterSecureStorage();
    var a = await storage.read(key: "accessToken");

    String token = a;
    var url =
    new Uri.http("api.vastwebindia.com", "/api/master/ShowActualIncome",{
      "from":frmDate,
