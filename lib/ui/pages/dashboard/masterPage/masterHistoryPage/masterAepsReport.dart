...
class MasterAepsReport extends StatefulWidget {
  const MasterAepsReport({Key key}) : super(key: key);

  @override
  _MasterAepsReportState createState() => _MasterAepsReportState();
}

class _MasterAepsReportState extends State<MasterAepsReport> {
 ...
 DateTime selectedDate2 = DateTime.now();
  ...
  Future<void> masterAepsHistory(String from1 ,String to1,String retailer1,String all1 ) async {
    ...
    var url = new Uri.http("api.vastwebindia.com", "/api/data/Master_Rem_AepsReport",
        {
  ...
  void initState() {
    ...
    masterAepsHistory(frmDate,toDate,retailerId,"ALL");
  }
      ...
      child: SafeArea(
        child: SimpleAppBarWidget(
          title: Align(
              ...
              child: Text(getTranslated(context, 'AEPS Report'),style: TextStyle(color: TextColor),textAlign: TextAlign.center,)),
