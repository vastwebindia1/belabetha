...
class MasterMpossReport extends StatefulWidget {
  const MasterMpossReport({Key key}) : super(key: key);

  @override
  _MasterMpossReportState createState() => _MasterMpossReportState();
}

class _MasterMpossReportState extends State<MasterMpossReport> {
 ...
 DateTime selectedDate2 = DateTime.now();
  ...
  Future<void> masterMpossHistory(String all1 ,String from1 ,String to1,String retailer1 ) async {
    ...
    var url = new Uri.http("api.vastwebindia.com", "/api/data/Master_Rem_m_possreport",
        {
          "ddl_status":all1,
          "txt_frm_date":from1,
          "txt_to_date":to1,
  ...
  void initState() {
    ...
    masterMpossHistory( "ALL",frmDate,toDate,retailerId);
                                                ...
                                                children: [
                                                  ...
                                                  Column(
                                                      ...
                                                      children: [
                                                        ...
                                                        Text (delHistory[index]["retailername"] == null ? "....." :delHistory[index]["retailername"],style: TextStyle(fontSize: 12,fontWeight: FontWeight.bold),),
                                                      ]),
                                                ],
                                              ),
                                              Column(
                                              ...
                                              child: Container(
                                                ...
                                                child: Column(
                                                  ...
                                                  children: [
                                                    ...
                                                    Text(delHistory[index]["senderno"]==null ? "...":delHistory[index]["senderno"].toString(),
                                              ...
                                              child: Container(
                                                ...
                                                child: Column(
                                                  ...
                                                  children: [
                                                    ...
                                                    Text("\u{20B9} " + delHistory[index]["charge"].toString() == null ? "..":delHistory[index]["charge"].toString(),style: TextStyle(fontSize: 12,fontWeight: FontWeight.bold),textAlign: TextAlign.center,)
                                                  ],
                                                ),
                                              ),
                                            ),
