...
class MasterMoneyTransferReport extends StatefulWidget {
  const MasterMoneyTransferReport({Key key}) : super(key: key);

  @override
  _MasterMoneyTransferReportState createState() => _MasterMoneyTransferReportState();
}

class _MasterMoneyTransferReportState extends State<MasterMoneyTransferReport> {
 ...
 DateTime selectedDate2 = DateTime.now();
  ...
  Future<void> masterMoneyTransferHistory( String page ,String from1 ,String to1,String retailer1,String all1,String all2,String all3 ) async {
    ...
    var url = new Uri.http("api.vastwebindia.com", "/api/data/Master_rem_MoneyTransferReport",
        {
          "pageindex" : page,
          "txt_frm_date" : from1,
          "txt_to_date" :to1,
  ...
  void initState() {
    ...
    masterMoneyTransferHistory(pageIndex.toString(),frmDate,toDate,retailerId,"","ALL","ALL");
                                            ...
                                            Expanded(
                                              child: Container(
                                                ...
                                                child: Column(
                                                  crossAxisAlignment: CrossAxisAlignment.center,
                                                  children: [
                                                    Text(getTranslated(context, 'Charge Type'),style: TextStyle(fontSize: 10),),
