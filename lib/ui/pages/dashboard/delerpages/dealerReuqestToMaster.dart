...
import 'package:myapp/ui/pages/dashboard/delerpages/dealerPaymentOptions.dart';
import 'package:myapp/ui/pages/dashboard/delerpages/delerHomeTopPages/dealerPurchaseOrder.dart';
import 'package:uuid/uuid.dart';


class DealerRequestToMaster extends StatefulWidget {
  final String masterAmount;

  const DealerRequestToMaster({Key key, this.masterAmount}) : super(key: key);

  @override
  _DealerRequestToMasterState createState() => _DealerRequestToMasterState();
}

class _DealerRequestToMasterState extends State<DealerRequestToMaster> {
  ...
  String masterBank1 = "Select Master Bank";
  ...
  Future<void> adminMasterBankList() async {
    ...
    String token = a;
    var url = new Uri.http("api.vastwebindia.com", "/api/data/AdminMasterBankList");
    ...
    if (response.statusCode == 200) {
      ...
      var distributerwallet = databind1["masterwalletlist"];
      var distributerbank = databind1["masterbanklistss"];
  ...
  Future<void> purchasemaster(String alfa1,String mode2,String type2, String collection2, String comment2, String deposit2, String utrno2, String account2, String walletno2,
        ...
        CoolAlert.show(
          ...
          onConfirmBtnTap: (){
            Navigator.pushReplacement(
                context,
                MaterialPageRoute(
                    builder: (context) => DealerPurchaseOrder()));
          },
        );
      } else {
        CoolAlert.show(
              ...
              children: [
                    ...
                    children: [
                      ConstrainedBox(
                          ...
                          child:FlatButton(
                            ...
                            child:Image.asset('assets/pngImages/Distributor.png',height: 35,),
                          )
                      ),
                      Positioned(
                        top: -1,
                ...
                Container(
                  child: Row(
                    ...
                    children: [
                      Text(getTranslated(context, 'Request to Master')),
                      Text("\u{20B9} " + widget.masterAmount,style: TextStyle(fontWeight: FontWeight.bold),),
                    ],
                  ),
                ),
  ...
  void requestmaster(String mode,String collection, String comment,String retailerroll,String dealerroll) async{
    ...
    String alfa = widget.masterAmount;
    ...
    purchasemaster(alfa, mode1,type1,collection1,comment1,deposit1,utrno1,account1,walletno1,
