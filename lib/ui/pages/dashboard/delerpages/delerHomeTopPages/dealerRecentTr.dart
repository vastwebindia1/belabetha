...
class DealerRecentTra extends StatefulWidget {
  const DealerRecentTra({Key key}) : super(key: key);

  @override
  _DealerRecentTraState createState() => _DealerRecentTraState();
}

class _DealerRecentTraState extends State<DealerRecentTra> {
  ...
  Future<void> dealerRecentHistory( String top ) async {
