...
class FundRequestToDealer extends StatefulWidget {
  const FundRequestToDealer({Key key}) : super(key: key);

  @override
  _FundRequestToDealerState createState() => _FundRequestToDealerState();
}

class _FundRequestToDealerState extends State<FundRequestToDealer> {
 ...
 DateTime selectedDate2 = DateTime.now();
  ...
  Future<void> retailerFundRequest(String from, String to) async {
    final storage = new FlutterSecureStorage();
    var a = await storage.read(key: "accessToken");

    String token = a;
    var url =
    new Uri.http("api.vastwebindia.com", "/api/data/DealerRetailerRequestRecivedReports", {
      "txt_frm_date":from,
      "txt_to_date" :to,
    });
  ...
  void initState() {
    ...
    retailerFundRequest(frmDate,toDate);
  }
                                      ...
                                      Container(
                                        child:Row(
                                          ...
                                          children: [
                                            Row(
                                              children: [
                                                requestList[index]["crests"] == "Pending"?
                                                Icon(Icons.watch_later,color: Colors.yellow[800],):
                                                    requestList[index]["crests"] == "CLEAR"?
                                                ...
                                                Column(
                                                    ...
                                                    children: [
                                                      ...
                                                      Text (requestList[index]["RemEmail"] == "" ? "....." :requestList[index]["RemEmail"],style: TextStyle(fontSize: 12,fontWeight: FontWeight.bold),),
                                                    ]),
                                              ],
                                            ),
                                            Column(
                                                ...
                                                children: [
                                                  ...
                                                  Text (requestList[index]["reqdate"] == null ? "0 0 0" :requestList[index]["reqdate"],style: TextStyle(fontSize: 12,fontWeight: FontWeight.bold,),),
                                                ]),
                                            ...
                                            child: Container(
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  ...
                                                  Text(requestList[index]["paymode"].toString(),
                                            ...
                                            child: Container(
                                              ...
                                              child: Column(
                                                children: [
                                                  ...
                                                  Text("\u{20B9} " + requestList[index]["amount"].toString(),style: TextStyle(fontSize: 12,fontWeight: FontWeight.bold),textAlign: TextAlign.right,)
                                                ],
                                              ),
                                            ),
                                          ),
                                            ...
                                            child: Container(
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  ...
                                                  Text("\u{20B9} " + requestList[index]["cashDepositCharge"].toString(),style: TextStyle(fontSize: 12,fontWeight: FontWeight.bold),textAlign: TextAlign.center,)
                                                ],
                                              ),
                                            ),
                                          ),
                                            ...
                                            child: Container(
                                              child: Column(
                                                ...
                                                children: [
                                                  ...
                                                  Text("\u{20B9} " + requestList[index]["finalAmount"].toString(),style: TextStyle(fontSize: 12,fontWeight: FontWeight.bold),textAlign: TextAlign.center,)
                                                ],
                                              ),
                                            ),
                                          ),
