...
class DealerRequestToAdmin extends StatefulWidget {

  final String masterAmount;

  const DealerRequestToAdmin({Key key, this.masterAmount}) : super(key: key);

  @override
  _DealerRequestToAdminState createState() => _DealerRequestToAdminState();
}

class _DealerRequestToAdminState extends State<DealerRequestToAdmin> {
    ...
    if (response.statusCode == 200) {
      ...
      if (status == "Success") {
        ...
        CoolAlert.show(
          ...
          onConfirmBtnTap: (){
            Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => DealerPurchaseOrder()));
          },
        );
      } else {
        CoolAlert.show(
