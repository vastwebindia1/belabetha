...
class DealerPanReport extends StatefulWidget {
  const DealerPanReport({Key key}) : super(key: key);

  @override
  _DealerPanReportState createState() => _DealerPanReportState();
}

class _DealerPanReportState extends State<DealerPanReport> {
 ...
 DateTime selectedDate2 = DateTime.now();
  ...
  Future<void> dealerPanHistory(String all1 ,String from1 ,String to1,String retailer1) async {
    ...
    var url = new Uri.http("api.vastwebindia.com", "/api/data/dealer_Rem_Pancard_report",
        {
          "ddl_status":all1,
          "txt_frm_date":from1,
          "txt_to_date":to1,
  ...
  void initState() {
    ...
    dealerPanHistory( "ALL",frmDate,toDate,retailerId,);
      ...
      child: SafeArea(
        child: SimpleAppBarWidget(
          title: Align(
              ...
              child: Text(getTranslated(context, 'PanCard Report'),style: TextStyle(color: TextColor),textAlign: TextAlign.center,)),
                                        ...
                                        Container(
                                          child:Row(
                                            ...
                                            children: [
                                              Row(
                                                children: [
                                                  delHistory[index]["Particulars"] == "Failed"?
                                                  Icon(Icons.cancel,color: Colors.red,):
                                                  delHistory[index]["Particulars"] == "Success"?
                                                  Icon(Icons.check_circle,color: Colors.green,):Icon(Icons.refresh,color: Colors.yellow[800],),
                                                  SizedBox(width: 5,),
                                                  Column(
                                                      crossAxisAlignment: CrossAxisAlignment.start,
                                                      children: [
                                                        Text(getTranslated(context, 'Name'),style: TextStyle(fontSize: 10,),),
                                                        Text (delHistory[index]["Frm_Name"] == "" ? "....." :delHistory[index]["Frm_Name"],style: TextStyle(fontSize: 12,fontWeight: FontWeight.bold),),
                                                      ]),
                                                ],
                                              ),
                                              Column(
                                                  ...
                                                  children: [
                                                    ...
                                                    Text (delHistory[index]["Date"] == null ? "0 0 0" :delHistory[index]["Date"],style: TextStyle(fontSize: 12,fontWeight: FontWeight.bold,),),
                                                  ]),
                                          ...
                                          children: [
                                            Expanded(
                                              child: Container(
                                                ...
                                                child: Column(
                                                  ...
                                                  mainAxisAlignment: MainAxisAlignment.center,
                                                  children: [
                                                    delHistory[index]["PhysicalCount"]==0 ?Text(
                                                      getTranslated(context, 'Digital Token'),
                                                      softWrap: true,
                                                      style: TextStyle(fontSize: 10),
                                                      textAlign: TextAlign.left,
                                                    ):Text(
                                                      getTranslated(context, 'Physical Token'),
                                                      softWrap: true,
                                                      style: TextStyle(fontSize: 10),
                                                      textAlign: TextAlign.left,
                                                    ),
                                                    delHistory[index]["PhysicalCount"] == 0?Text(delHistory[index]["DigitalCount"].toString(),
                                                      overflow: TextOverflow.ellipsis,
                                                      maxLines: 1,
                                                      style: TextStyle(fontSize: 12,fontWeight: FontWeight.bold),
                                                      textAlign: TextAlign.center,
                                                    ):Text(delHistory[index]["PhysicalCount"].toString(),
                                                      overflow: TextOverflow.ellipsis,
                                                      maxLines: 1,
                                                      style: TextStyle(fontSize: 12,fontWeight: FontWeight.bold),
                                                      textAlign: TextAlign.center,
                                            ...
                                            Expanded(
                                              child: Container(
                                                ...
                                                child: Column(
                                                  children: [
                                                    Text("Process Fee",style: TextStyle(fontSize: 10),),
                                                    Text("\u{20B9} " + delHistory[index]["ProcessingFees"].toString(),style: TextStyle(fontSize: 12,fontWeight: FontWeight.bold),textAlign: TextAlign.right,)
                                                  ],
                                                ),
                                              ),
                                            ),
                                            Expanded(
                                              child: Container(
                                                ...
                                                child: Column(
                                                  crossAxisAlignment: CrossAxisAlignment.center,
                                                  children: [
                                                    Text("Retailer Income.",style: TextStyle(fontSize: 10),),
                                                    Text("\u{20B9} " + delHistory[index]["RetailerIncome"].toString(),style: TextStyle(fontSize: 12,fontWeight: FontWeight.bold),textAlign: TextAlign.center,)
                                                  ],
                                                ),
                                              ),
                                            ),
                                            Expanded(
                                              child: Container(
                                                child: Column(
                                                  crossAxisAlignment: CrossAxisAlignment.end,
                                                  children: [
                                                    Text("Dealer Income",style: TextStyle(fontSize: 10),),
                                                    Text("\u{20B9} " + delHistory[index]["DealerIncome"].toString(),style: TextStyle(fontSize: 12,fontWeight: FontWeight.bold),textAlign: TextAlign.center,)
                                                  ],
                                                ),
                                              ),
                                            ),
