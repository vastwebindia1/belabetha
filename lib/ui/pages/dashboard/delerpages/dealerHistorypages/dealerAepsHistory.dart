...
class DealerAepsReport extends StatefulWidget {
  const DealerAepsReport({Key key}) : super(key: key);

  @override
  _DealerAepsReportState createState() => _DealerAepsReportState();
}

class _DealerAepsReportState extends State<DealerAepsReport> {
 ...
 DateTime selectedDate2 = DateTime.now();
  ...
  Future<void> dealerAepsHistory(String from1 ,String to1,String retailer1,String all1 ) async {
    ...
    var url = new Uri.http("api.vastwebindia.com", "/api/data/dealer_Rem_AepsReport",
        {
  ...
  void initState() {
    ...
    dealerAepsHistory(frmDate,toDate,retailerId,"ALL");
      ...
      child: SafeArea(
        child: SimpleAppBarWidget(
          title: Align(
              ...
              child: Text("Aeps Aadhar Report ",style: TextStyle(color: TextColor),textAlign: TextAlign.center,)),
                                            ...
                                            children: [
                                              ...
                                              Column(
                                                  ...
                                                  children: [
                                                    ...
                                                    Text (delHistory[index]["Txn_Date"] == null ? "0 0 0" :delHistory[index]["Txn_Date"],style: TextStyle(fontSize: 12,fontWeight: FontWeight.bold,),),
                                                  ]),
                                              ...
                                              child: Container(
                                                ...
                                                child: Column(
                                                  ...
                                                  children: [
                                                    ...
                                                    Text(delHistory[index]["AccountHolderAadhaar"].toString(),
                                              ...
                                              child: Container(
                                                ...
                                                child: Column(
                                                  ...
                                                  children: [
                                                    ...
                                                    Text( delHistory[index]["Type"],style: TextStyle(fontSize: 12,fontWeight: FontWeight.bold),textAlign: TextAlign.center,)
                                                  ],
                                                ),
                                              ),
                                            ),
                                          ...
                                          children: [
                                            Expanded(
                                                child: Column(
                                                  crossAxisAlignment: CrossAxisAlignment.start,
                                                  children: [
                                                    Text("Bank UTR",style: TextStyle(fontSize: 10,),),
                                                    Text (delHistory[index]["BankRRN"] == "" ? "....." :delHistory[index]["BankRRN"],style: TextStyle(fontSize: 12,fontWeight: FontWeight.bold),),
                                                  ],
                                                )),
                                          ],
                                        ),
