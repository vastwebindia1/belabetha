...
class DealerMpossReport extends StatefulWidget {
  const DealerMpossReport({Key key}) : super(key: key);

  @override
  _DealerMpossReportState createState() => _DealerMpossReportState();
}

class _DealerMpossReportState extends State<DealerMpossReport> {
 ...
 DateTime selectedDate2 = DateTime.now();
  ...
  Future<void> dealerMpossHistory(String all1 ,String from1 ,String to1,String retailer1 ) async {
    ...
    var url = new Uri.http("api.vastwebindia.com", "/api/data/dealer_Rem_m_possreport",
        {
          "ddl_status":all1,
          "txt_frm_date":from1,
          "txt_to_date":to1,
  ...
  void initState() {
    ...
    dealerMpossHistory( "ALL",frmDate,toDate,retailerId,);
      ...
      child: SafeArea(
        child: SimpleAppBarWidget(
          title: Align(
              ...
              child: Text(getTranslated(context, 'Mposs Report'),style: TextStyle(color: TextColor),textAlign: TextAlign.center,)),
                                              ...
                                              child: Container(
                                                ...
                                                child: Column(
                                                  ...
                                                  children: [
                                                    ...
                                                    Text(delHistory[index]["transType"].toString(),
                                            ...
                                            Expanded(
                                              child: Container(
                                                ...
                                                child: Column(
                                                  crossAxisAlignment: CrossAxisAlignment.center,
                                                  children: [
                                                    Text("Retailer Comm",style: TextStyle(fontSize: 10),),
                                                    Text("\u{20B9} " + delHistory[index]["remincome"].toString(),style: TextStyle(fontSize: 12,fontWeight: FontWeight.bold),textAlign: TextAlign.center,)
                                                  ],
                                                ),
                                              ),
                                            ),
                                            Expanded(
                                              child: Container(
                                                child: Column(
                                                  crossAxisAlignment: CrossAxisAlignment.end,
                                                  children: [
                                                    Text("Total Amount",style: TextStyle(fontSize: 10),),
