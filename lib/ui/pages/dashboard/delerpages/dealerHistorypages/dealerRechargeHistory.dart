...
import 'package:myapp/CommanWidget/timeoutbar.dart';
import 'package:myapp/ThemeColor/Color.dart';
import 'package:myapp/ui/pages/Languages/localization/language_constants.dart';
import 'package:sticky_headers/sticky_headers.dart';
import 'package:http/http.dart'as http;

class DealerRechargeHistory extends StatefulWidget {


  const DealerRechargeHistory({Key key}) : super(key: key);

  @override
  _DealerRechargeHistoryState createState() => _DealerRechargeHistoryState();
}

class _DealerRechargeHistoryState extends State<DealerRechargeHistory> {
 ...
 DateTime selectedDate2 = DateTime.now();
  ...
  Future<void> dealerRechargeHistory(String pgrind ,String retailerid, String fromdate, String todate, String role, String rechargenum,String status, String optname) async {
    ...
    try{
      ...
      var uri =
      new Uri.http("api.vastwebindia.com", "/api/data/dealer_rem_rch_report", {
        "pageindex": pgrind,
        "pagesize": "500",
  ...
  void retid() async{
    ...
    dealerRechargeHistory(pageIndex.toString(),userid, frmDate, toDate, "Dealer", "ALL", "ALL", "ALL");
                                    ...
                                    Container(
                                      ...
                                      child:IconButton(
                                        ...
                                        onPressed: () async{
                                          ...
                                          originalItems.clear();
                                          items.clear();
                                          dealerRechargeHistory(pageIndex.toString(),userid, frmDate, toDate, "Dealer", _rechanumber.text, statuss, "ALL");
                                            ...
                                            children: [
                                              ...
                                              Container(
                                                ...
                                                child: Column(
                                                  ...
                                                  mainAxisAlignment: MainAxisAlignment.center,
                                                  children: [
                                                    Text(getTranslated(context, 'User Earn') +" \u{20B9} " +items[index]["Commision"].toString(),textAlign: TextAlign.right,),
                                              ...
                                              Expanded(
                                                child: Container(
                                                  child: Row(
                                                    crossAxisAlignment: CrossAxisAlignment.start,
                                                    children: [
                                                      Text("Retailer Firm Name     :  " +items[index]["frm_name"].toString(),textAlign: TextAlign.right,),
