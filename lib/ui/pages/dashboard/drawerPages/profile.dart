...
class _ProfileState extends State<Profile> {
  ...
  Future<void> profileUpload1(String name3, String mobile3,String dob3,String email3,
      String position3,String business3,String aadhar3,String pan3,String gst3,String firm3,
      String address3,String pincode3,String districtId3,String StateId3, String pin3,
      String password3,String joinDate3,String cityName3) async {
    ...
    var url = new Uri.http("api.vastwebindia.com", "/Retailer/api/data/UpdateRetailerProfile");
  ...
  _pickImageFromGallery() async {
    PickedFile pickedFile = await aadharFrontGalleryPicker.getImage(source: ImageSource.gallery, imageQuality: 50);
  ...
  _pickImageFromCamera() async {
    PickedFile pickedFile = await aadharFrontCameraPicker.getImage(source: ImageSource.camera, imageQuality: 50);
  ...
  _pickImageFromGallery2() async {
    PickedFile pickedFile = await aadharBackGalleryPicker.getImage(source: ImageSource.gallery);
  ...
  _pickImageFromCamera2() async {
    PickedFile pickedFile = await aadharBackCameraPicker.getImage(source: ImageSource.camera, imageQuality: 50);
  ...
  Future<void> uploadAadhar(String front, String back ,String id, String roll) async {
    ...
    String token = a;
    var url =
    new Uri.https("test.vastwebindia.com", "/api/user/UploadDocumentsImages");
    Map map = {
                ...
                children: [
                  Row(
                    children: [
                      ...
                      Text(dialogName.toUpperCase(), style: TextStyle(fontSize: 18),),
                    ],
                  ),
                  Container(
                  ...
                  children: [
                    Row(
                      children: [
                        ...
                        Text(getTranslated(context, 'Image'), style: TextStyle(fontSize: 18,color: TextColor),),
                      ],
                    ),
                    Container(
                      alignment: Alignment.center,
                          ...
                          Container(
                            ...
                            child: ClipRRect(
                              ...
                              child: Image(
                                ...
                                height: 170,
                                fit: BoxFit.fill,
                                image: NetworkImage("https://test.vastwebindia.com/" + checkAadharFrontPath1),
                              ),
                            ),
                          ...
                          Container(
                            ...
                            child: ClipRRect(
                              ...
                              child: Image(
                                ...
                                height: 170,
                                fit: BoxFit.fill,
                                image: NetworkImage("https://test.vastwebindia.com/" + checkAadharbackpath1),
                              ),
                            ),
                          ),
                        ],
                ...
                child: Row(
                  ...
                  children: [
                    Row(
                      children: [
                        Icon(Icons.upload_file,color: SecondaryColor,size: 20,),
                        Text(uploadType.toUpperCase() == getTranslated(context, 'upload PanCard Pic') ? getTranslated(context, 'Upload pan Card') :uploadType.toUpperCase(), style: TextStyle(fontSize: 18,color: TextColor,),),
                      ],
                    ),
                    Container(
                      alignment: Alignment.center,
                      ...
                      children: [
                        ...
                        Container(
                          width: MediaQuery.of(context).size.width/1.5,
                            child: Text(viewType == getTranslated(context, 'View panCard') ? getTranslated(context, 'View PanCard pic') :viewType == null ?"":viewType, style: TextStyle(fontSize: 18,color: TextColor),overflow: TextOverflow.ellipsis,)),
                      ],
                    ),
                    Container(
                      alignment: Alignment.center,
                ...
                child: Column(
                  ...
                  children: [
                    Container(
                      ...
                      child: viewType ==getTranslated(context, 'View panCard pic') ? Image(
                        width: 290,
                        height: 200,
                        fit: BoxFit.fill,
                        image: NetworkImage("https://test.vastwebindia.com/" + checkPanPath1),
                      )
                          : viewType == getTranslated(context, 'Selfie View') ? Image(
                        width: 290,
                        height: 200,
                        fit: BoxFit.fill,
                        image: NetworkImage("https://test.vastwebindia.com/" + checkSelfieShop1),
                      )
                          : viewType == getTranslated(context, 'View Gst pic') ? Image(
                        width: 290,
                        height: 200,
                        fit: BoxFit.fill,
                        image: NetworkImage("https://test.vastwebindia.com/" + checkRegisterPath1),
                      )
                          : viewType == getTranslated(context, 'View Service Agreement') ? Image(
                        width: 290,
                        height: 200,
                        fit: BoxFit.fill,
                        image: NetworkImage("https://test.vastwebindia.com/" + checkServiceAgrementPath1),
                      )
                          : Image(
                        width: 290,
                        height: 200,
                        fit: BoxFit.fill,
                        image: NetworkImage("https://www.planetware.com/wpimages/2020/02/france-in-pictures-beautiful-places-to-photograph-eiffel-tower.jpg"),
                      ),
                    ),
  ...
  String url ="https://test.vastwebindia.com/";
                                    ...
                                    Expanded(
                                      child: Container(
                                        ...
                                        child: Column(
                                          crossAxisAlignment: CrossAxisAlignment.center,
                                          children: [
                                            Text(getTranslated(context, 'Selfie With Representative'),style: TextStyle(fontSize: 8,),textAlign: TextAlign.start,overflow: TextOverflow.ellipsis,),
                                            Row(
                                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                              children: [
                                                ...
                                                Container(
                                                  ...
                                                  child: FlatButton(
                                                    ...
                                                    child:Text(selfieShopStatus1 == "N" && checkSelfieShop1 == "null"  ? getTranslated(context, 'Upload')
                                    ...
                                    Expanded(
                                      child: Container(
                                        ...
                                        child: Column(
                                          crossAxisAlignment: CrossAxisAlignment.center,
                                          children: [
                                            Text(getTranslated(context, 'Work Service Agreement'),style: TextStyle(fontSize: 8,),textAlign: TextAlign.start,overflow: TextOverflow.ellipsis,),
                                            Row(
                                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                              children: [
                                                ...
                                                Container(
                                                  ...
                                                  child: FlatButton(
                                                    ...
                                                    child:Text(serviceAgreeStatus1 == "false" && checkServiceAgrementPath1 == "null" ? getTranslated(context, 'Upload')
                                                        : getTranslated(context, 'View'),style: TextStyle(fontSize: 10,),),
                                                  ),
                                                ),
                                              ],
                                    ...
                                    Expanded(
                                      child: Container(
                                        ...
                                        child: Column(
                                          crossAxisAlignment: CrossAxisAlignment.center,
                                          children: [
                                            Text(getTranslated(context, 'View Status My Video KYC'),style: TextStyle(fontSize: 8,),textAlign: TextAlign.start,overflow: TextOverflow.ellipsis,),
                                            Row(
                                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                              children: [
                                          ...
                                          child: FlatButton(
                                            ...
                                            onPressed: () {
                                              setState(() {
                                                ...
                                                profileUpload1(NameController.text,MobileController.text,DobController.text,
                                      ...
                                      child: FlatButton(
                                        ...
                                        onPressed: () {
                                          setState(() {
                                            ...
                                            profileUpload1(name1,mobile1,dobDate1,
