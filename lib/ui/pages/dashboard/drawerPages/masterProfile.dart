...
class _MasterProfileState extends State<MasterProfile> {
  ...
  Future<void> masterRemProfile(String masterid) async {
    final storage = new FlutterSecureStorage();
    var a = await storage.read(key: "accessToken");

    String token = a;

    var url = new Uri.http("api.vastwebindia.com", "/api/master/Profile", {
      "MDID": masterid,
    });
    ...
    if (response.statusCode == 200) {
      ...
      if (status == "Success") {
        ...
        CoolAlert.show(
          ...
          onConfirmBtnTap: (){
            Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => MasterProfile()));
          },
        );
      } else {
        ...
        CoolAlert.show(
          ...
          onConfirmBtnTap: (){
            Navigator.pushReplacement(context,
                MaterialPageRoute(builder: (context) => MasterProfile()));
          },
        );
      }else{
                ...
                child: Row(
                  ...
                  children: [
                    Row(
                      children: [
                        Icon(Icons.image_rounded,color: SecondaryColor,size: 20,),
                        Text(viewType == getTranslated(context, 'View panCard pic') ? getTranslated(context, 'View PanCard') :viewType, style: TextStyle(fontSize: 18,color: TextColor),),
                      ],
                    ),
                    Container(
                      alignment: Alignment.center,
