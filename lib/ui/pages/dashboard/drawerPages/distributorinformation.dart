...
class DistributorInformation extends StatefulWidget {
  @override
  _DistributorInformationState createState() => _DistributorInformationState();
}

class _DistributorInformationState extends State<DistributorInformation> {
  ...
  Future<void> dealerInform() async {

    final storage = new FlutterSecureStorage();
    var a = await storage.read(key: "accessToken");

    String token = a;
    var url = new Uri.http("api.vastwebindia.com", "/Retailer/api/Data/DealerInfo");
                  ...
                  children: [
                    Column(
                      children: [
                        ...
                        SizedBox(height: 5,),
                        Text("Distributor Information",style: TextStyle(color: TextColor,fontSize: 18,),),
                        Container(
                          child: Container(
