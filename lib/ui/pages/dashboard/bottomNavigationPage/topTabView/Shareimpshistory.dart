...
class PrintImpsdata extends StatefulWidget {
  const PrintImpsdata({Key key, this.Number, this.amount, this.status, this.bnkname, this.txntype, this.trnsid, this.date, this.accno, this.ifsc}) : super(key: key);
  final String Number;
  final String amount;
  final String status;
  ...
  @override
  _PrintImpsdataState createState() => _PrintImpsdataState();
}

class _PrintImpsdataState extends State<PrintImpsdata> {
              ...
              pw.Container(
                  child: pw.Column(
                      ...
                      children: [
                        ...
                        pw.Center(
                            child: pw.Container(
                                child: pw.Text("IMPS History",style: pw.TextStyle(fontWeight: pw.FontWeight.bold,fontSize: 30))
                            )
                        ),
                        pw.SizedBox(
                            height: 20
                        ...
                        pw.Container(
                          ...
                          child: pw.Row(
                              ...
                              children: [
                                ...
                                pw.Text("Sender Number : ",style: pw.TextStyle(fontWeight: pw.FontWeight.bold,fontSize: 20)),
                        ...
                        pw.Container(
                          ...
                          child: pw.Row(
                              ...
                              children: [
                                ...
                                pw.Text(widget.bnkname,style: pw.TextStyle(fontWeight: pw.FontWeight.bold,fontSize: 20)),
                              ]
                          ),
                        ),
                        ...
                        pw.Container(
                          ...
                          child: pw.Row(
                              ...
                              children: [
                                ...
                                pw.Text("Acc No.: ",style: pw.TextStyle(fontWeight: pw.FontWeight.bold,fontSize: 20)),
                        ...
                        pw.Container(
                          ...
                          child: pw.Row(
                              ...
                              children: [
                                ...
                                pw.Text("IFSC Code : ",style: pw.TextStyle(fontWeight: pw.FontWeight.bold,fontSize: 20)),
                                pw.Text(widget.ifsc,style: pw.TextStyle(fontWeight: pw.FontWeight.bold,fontSize: 20)),
                              ]
                          ),
                        ),
