...
class FlighthistoryPage extends StatefulWidget {
  const FlighthistoryPage({Key key}) : super(key: key);

  @override
  _FlighthistoryPageState createState() => _FlighthistoryPageState();
}
...
class _FlighthistoryPageState extends State<FlighthistoryPage> {
 ...
 DateTime selectedDate2 = DateTime.now();
  ...
  Future<void> flighthistory(String pgrind , String fromdate, String todate,String status) async {
    ...
    try{
      ...
      var uri =
      new Uri.http("api.vastwebindia.com", "/AIR/api/app/Air/TicketReport", {
        "pageindex": pgrind,
        "pagesize": "500",
  ...
  void retid() async{
    ...
    flighthistory(pageIndex.toString(), frmDate, toDate,"ALL");
  }
        ...
        child: Scaffold(
          ...
          appBar: AppBar(
            ...
            title: Align(
                ...
                child: Text(getTranslated(context, 'Flight History'),style: TextStyle(color: TextColor),textAlign: TextAlign.center,)),
            elevation: 0,
            toolbarHeight: 39,
            leadingWidth: 60,
                                    ...
                                    Container(
                                      ...
                                      child:IconButton(
                                        ...
                                        onPressed: () async{
                                          ...
                                          originalItems.clear();
                                          items.clear();
                                          flighthistory(pageIndex.toString(), frmDate, toDate, statuss);
                                                  ...
                                                  children: [
                                                    Container(
                                                      ...
                                                      child: CircleAvatar(
                                                          ...
                                                          child: Image.asset('assets/pngImages/Flight.png')
                                                      ),
                                                    ...
                                                    Flexible(
                                                      ...
                                                      child: Container(
                                                        ...
                                                        child: Column(
                                                          ...
                                                          children: [
                                                           Text(
                                                              items[index]["AirlineName"]== "" ? getTranslated(context, 'No Name'):items[index]["AirlineName"],
                                                              style: TextStyle(fontSize: 12),
                                                              textAlign: TextAlign.left,
                                                            ),
                                                            SizedBox(height: 1,),
                                                           Text(
                                                               items[index]["PNR"].toString()== "" ? getTranslated(context, 'No PNR Number') :items[index]["PNR"].toString(),
                                                              maxLines: 2,
                                                ...
                                                child: Column(
                                                  ...
                                                  children: [
                                                    Row(
                                                      ...
                                                      children: [
                                                        items[index]["TicketStatus"] == "SUCCESS" ? Icon(Icons.check_circle,color: Colors.green,size: 14,) : items[index]["TicketStatus"] == "Proccessed" ? Icon(Icons.watch_later,color: Colors.yellow[800],size: 16,) : items[index]["TicketStatus"] == "FAILED" ? Icon(Icons.cancel,color: Colors.red,size: 16,) : Icon(Icons.refresh,color: Colors.deepOrangeAccent,size: 16,),

                                                        Padding(
                                                          padding: const EdgeInsets.only(left: 3),
                                                          child: Text(items[index]["TicketStatus"] == "" ? getTranslated(context, 'Ticket Status Not available'):items[index]["TicketStatus"],style: TextStyle(fontSize: 12),overflow: TextOverflow.ellipsis,),
                                                        ),
                                                      ],
                                                    ),
                                                    SizedBox(height: 1,),
                                                    ...
                                                    Flexible(
                                                      ...
                                                      child: Container(
                                                        ...
                                                        child: Column(
                                                          ...
                                                          children: [
                                                            Text(
                                                              items[index]["PassengerName"] == "" ? getTranslated(context, 'No Name'):items[index]["PassengerName"],
                                            ...
                                            Expanded(
                                              child: Container(
                                                ...
                                                child: Column(
                                                  crossAxisAlignment: CrossAxisAlignment.end,
                                                  children: [
                                                    Text(getTranslated(context, 'Offer Fare'),style: TextStyle(fontSize: 12),overflow: TextOverflow.ellipsis,),
                                                    SizedBox(height: 1,),
                                                    Text("\u{20B9} " + items[index]["OfferedFare"].toString(),style: TextStyle(fontWeight: FontWeight.bold),textAlign: TextAlign.right,)
                                                  ],
                                                ),
                                              ),
                                            )
                                                    ...
                                                    children: [
                                                      Expanded(
                                                        child: Container(
                                                          ...
                                                          child: Column(
                                                            children: [
                                                              Text(getTranslated(context, 'Trace ID'),
                                                                style: TextStyle(fontSize: 12),
