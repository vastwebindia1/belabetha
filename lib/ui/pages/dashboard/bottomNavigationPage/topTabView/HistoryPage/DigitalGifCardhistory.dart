...
class giftcardhistory extends StatefulWidget {
  const giftcardhistory({Key key}) : super(key: key);

  @override
  _giftcardhistoryState createState() => _giftcardhistoryState();
}
        ...
        child: Scaffold(
          ...
          appBar: AppBar(
            ...
            title: Align(
                ...
                child: Text(getTranslated(context, 'Gift Card History'),style: TextStyle(color: TextColor),textAlign: TextAlign.center,)),
            elevation: 0,
            toolbarHeight: 39,
            leadingWidth: 60,
