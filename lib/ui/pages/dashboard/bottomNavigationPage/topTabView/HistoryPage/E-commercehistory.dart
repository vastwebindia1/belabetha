...
class ecommhistorypage extends StatefulWidget {
  const ecommhistorypage({Key key}) : super(key: key);

  @override
  _ecommhistorypageState createState() => _ecommhistorypageState();
}

class _ecommhistorypageState extends State<ecommhistorypage> {
  String frmDate = "";
  String toDate = "";
        ...
        child: Scaffold(
          ...
          appBar: AppBar(
            ...
            title: Align(
                ...
                child: Text(getTranslated(context, 'E-Commerce History'),style: TextStyle(color: TextColor),textAlign: TextAlign.center,maxLines: 1,),),
            elevation: 0,
            toolbarHeight: 39,
            leadingWidth: 60,
