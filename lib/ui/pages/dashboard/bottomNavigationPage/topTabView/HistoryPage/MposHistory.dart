...
class Mposhistorypage extends StatefulWidget {
  const Mposhistorypage({Key key}) : super(key: key);

  @override
  _MposhistorypageState createState() => _MposhistorypageState();
}

class _MposhistorypageState extends State<Mposhistorypage> {
  String frmDate = "";
  String toDate = "";
 ...
 DateTime selectedDate2 = DateTime.now();
  ...
  Future<void> Mposhistory(String pgrind ,String retailerid, String fromdate, String todate, String role,String status, String trantypr, String sendnum) async {
    ...
    try{
      ...
      var uri =
      new Uri.http("api.vastwebindia.com", "/MPOS/api/mPos/History", {
  ...
  void retid() async{
    ...
    Mposhistory(pageIndex.toString(),userid, frmDate, toDate, "Retailer","ALL","ALL","");
  }
        ...
        child: Scaffold(
          ...
          appBar: AppBar(
            ...
            title: Align(
                ...
                child: Text(getTranslated(context, 'M-Pos History') ,style: TextStyle(color: TextColor),textAlign: TextAlign.center,)),
            elevation: 0,
            toolbarHeight: 39,
            leadingWidth: 60,
                                            ...
                                            Expanded(
                                                child: Container(
                                                  ...
                                                  child: DropdownButtonFormField<String>(
                                                    ...
                                                    items:[getTranslated(context, 'All Transaction'),getTranslated(context, 'Ac/c Verification'),"IMPS",getTranslated(context, 'NEFT'),getTranslated(context, 'UPI'),"Wallet"].map((item) {
                                                      return new DropdownMenuItem(
                                                        child:   Text(item,style: TextStyle(color: TextColor),),
                                                        value: item,
                                                      );
                                                    ...
                                                    onChanged: (String val) {
                                                      ...
                                                      if(val == getTranslated(context, 'All Transaction')){

                                                        setState(() {
                                                          paymode = "ALL";
                                                        });

                                                      }else if(val == getTranslated(context, 'Ac/c Verification')){
                                                      ...
                                                      }else if(val == getTranslated(context, 'NEFT')){
                                    ...
                                    Container(
                                      ...
                                      child:IconButton(icon: Icon(Icons.search,),
                                        ...
                                        onPressed: () async{
                                          ...
                                          originalItems.clear();
                                          items.clear();
                                          Mposhistory(pageIndex.toString(),userid, frmDate, toDate, "Retailer", statuss,paymode,_rechanumber.text);
                                                    ...
                                                    Flexible(
                                                      ...
                                                      child: Container(
                                                        ...
                                                        child: Column(
                                                          ...
                                                          children: [
                                                            Text(
                                                              getTranslated(context, 'TXN ID') +" : " + items[index]["TxnId"],
                                                    ...
                                                    Flexible(
                                                      ...
                                                      child: Container(
                                                        ...
                                                        child: Column(
                                                          ...
                                                          children: [
                                                            Text(
                                                              getTranslated(context, 'Card Holder Name'),
                                                              softWrap: true,
                                                              style: TextStyle(fontSize: 12),
                                                              textAlign: TextAlign.left,
                                                            ),
                                                            SizedBox(height: 1,),
                                                            Text(
                                                              items[index]["cardholdername"] == ""? "" : items[index]["cardholdername"],
                                              ...
                                              child: Container(
                                                ...
                                                child: Column(
                                                  ...
                                                  children: [
                                                    ...
                                                    SizedBox(height: 1,),
                                                    items[index]["cardnumber"] == "" ? Text("") :Text(items[index]["cardnumber"],style: TextStyle(fontWeight: FontWeight.bold),textAlign: TextAlign.right,)
                                                  ],
                                                ),
                                              ),
                                            )
                                                        ...
                                                        child: Container(
                                                          ...
                                                          child: Column(
                                                            children: [
                                                              ...
                                                              SizedBox(height: 1,),
                                                              Text(items[index]["TxnId"].toString(),textAlign: TextAlign.right,)
                                                            ],
                                                          ),
                                                        ),
                                                      ),
                                                      Expanded(
                                                        child: Container(
                                                          ...
                                                          child: Column(
                                                            ...
                                                            children: [
                                                              Text(
                                                                getTranslated(context, 'Request ID'),
                                                                style: TextStyle(fontSize: 12),
                                                                overflow: TextOverflow.ellipsis,softWrap: true,textAlign: TextAlign.right,),
                                                              SizedBox(height: 1,),
                                                              Text(items[index]["reqid"].toString(),textAlign: TextAlign.right,)
                                                            ],
                                                          ),
                                                        ),
                                                      ),
                                                    ...
                                                    children: [
                                                        ...
                                                        child: Container(
                                                          ...
                                                          child: Column(
                                                            ...
                                                            children: [
                                                              ...
                                                              SizedBox(height: 1,),
                                                              Text("\u{20B9} " + items[index]["RetailerPre"].toString(),textAlign: TextAlign.right,)
                                                            ],
                                                          ),
                                                        ),
                                                      ),
                                                      ...
                                                      Expanded(
                                                        child: Container(
                                                          ...
                                                          child: Column(
                                                            children: [
                                                              Text(getTranslated(context, 'Card Type').toUpperCase(),style: TextStyle(fontSize: 12),overflow: TextOverflow.ellipsis,softWrap: true,),
                                                              SizedBox(height: 1,),
                                                              Text(items[index]["cardtype"].toString(),textAlign: TextAlign.right,)
                                                            ],
                                                          ),
                                                        ),
                                                      ),
                                                        ...
                                                        child: Container(
                                                          ...
                                                          child: Column(
                                                            children: [
                                                              ...
                                                              SizedBox(height: 1,),
                                                              Text("\u{20B9} " + items[index]["RetailerPost"].toString(),textAlign: TextAlign.right,)
                                                            ],
                                                          ),
                                                        ),
                                                      ),
                                                    ...
                                                    children: [
                                                        ...
                                                        child: Container(
                                                          ...
                                                          child: Column(
                                                            children: [
                                                              ...
                                                              SizedBox(height: 1,),
                                                              Text("\u{20B9} " + items[index]["Rem_Comm"].toString(),textAlign: TextAlign.right,)
                                                            ],
                                                          ),
                                                        ),
                                                      ),
                                                      ...
                                                      Expanded(
                                                        child: Container(
                                                          ...
                                                          child: Column(
                                                            children: [
                                                              Text(getTranslated(context, 'Bank RRN'),style: TextStyle(fontSize: 12),overflow: TextOverflow.ellipsis,softWrap: true,),
                                                              SizedBox(height: 1,),
                                                              Text(items[index]["BankRRN"],textAlign: TextAlign.right,)
                                                            ],
                                                          ),
                                                        ),
                                                      ),
