...
class HotelbookHistoryPage extends StatefulWidget {
  const HotelbookHistoryPage({Key key}) : super(key: key);

  @override
  _HotelbookHistoryPageState createState() => _HotelbookHistoryPageState();
}

class _HotelbookHistoryPageState extends State<HotelbookHistoryPage> {
  String frmDate = "";
  String toDate = "";
 ...
 DateTime selectedDate2 = DateTime.now();
  ...
  /*Future<void> hotelhistory(String fromdate, String todate,String status) async {
...
*/
  ...
  void retid() async{
    ...
    /*hotelhistory(frmDate, toDate,"ALL");*/
  }
        ...
        child: Scaffold(
          ...
          appBar: AppBar(
            ...
            title: Align(
                ...
                child: Text(getTranslated(context, 'Hotel Booking History'),style: TextStyle(color: TextColor),textAlign: TextAlign.center,)),
            elevation: 0,
            toolbarHeight: 39,
            leadingWidth: 60,
                                    ...
                                    Container(
                                      ...
                                      child:IconButton(
                                        ...
                                        onPressed: () async{
                                          ...
                                          originalItems.clear();
                                          items.clear();
                                        /*  hotelhistory(frmDate, toDate, statuss);
*/
