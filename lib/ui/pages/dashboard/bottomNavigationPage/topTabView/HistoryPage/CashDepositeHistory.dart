...
class CashDepositeHistoryPage extends StatefulWidget {
  const CashDepositeHistoryPage({Key key}) : super(key: key);

  @override
  _CashDepositeHistoryPageState createState() => _CashDepositeHistoryPageState();
}

class _CashDepositeHistoryPageState extends State<CashDepositeHistoryPage> {
  String frmDate = "";
  String toDate = "";
 ...
 DateTime selectedDate2 = DateTime.now();
  ...
  Future<void> cashdeposite(String fromdate, String todate,String status) async {
    ...
    try{
      ...
      var uri =
      new Uri.http("api.vastwebindia.com", "/api/data/CashDepositHistory", {
        "from": fromdate,
        "to": todate,
        "status": status,
      });
  ...
  void retid() async{
    ...
    cashdeposite(frmDate, toDate,"ALL");
  }
        ...
        child: Scaffold(
          ...
          appBar: AppBar(
            ...
            title: Align(
                ...
                child: Text(getTranslated(context, 'Cash Deposit History'),style: TextStyle(color: TextColor),textAlign: TextAlign.center,)),
            elevation: 0,
            toolbarHeight: 39,
            leadingWidth: 60,
                                    ...
                                    Container(
                                      ...
                                      child:IconButton(
                                        ...
                                        onPressed: () async{
                                          ...
                                          originalItems.clear();
                                          items.clear();
                                          cashdeposite(frmDate, toDate, statuss);
                                                  ...
                                                  children: [
                                                    Container(
                                                      ...
                                                      child: CircleAvatar(
                                                          ...
                                                          child: Image.asset('assets/pngImages/bank.png')
                                                      ),
                                                    ...
                                                    Flexible(
                                                      ...
                                                      child: Container(
                                                        ...
                                                        child: Column(
                                                          ...
                                                          mainAxisAlignment: MainAxisAlignment.center,
                                                          children: [
                                                            items[index]["bankname"] == null ? Text("") :Text(
                                                              items[index]["bankname"],
                                                              style: TextStyle(fontSize: 12),
                                                              textAlign: TextAlign.left,
                                                            ),
                                                            SizedBox(height: 1,),
                                                            items[index]["accountno"] == null ? Text(""): Text(
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  Row(
                                                    ...
                                                    children: [
                                                      items[index]["status"] == "Success" ? Icon(Icons.check_circle,color: Colors.green,size: 16,) : items[index]["status"] == "Pending" ? Icon(Icons.watch_later,color: Colors.yellow[800],size: 16,) : items[index]["status"] == "Failed" ? Icon(Icons.cancel,color: Colors.red,size: 16,) : Icon(Icons.refresh,color: Colors.deepOrangeAccent,size: 16,),

                                                      Flexible(
                                                        child: Padding(
                                                          padding: const EdgeInsets.only(left: 3),
                                                          child: Text(items[index]["status"],style: TextStyle(fontSize: 12),overflow: TextOverflow.clip,textAlign: TextAlign.right,),
                                                        ),
                                                      ),
                                                    ],
                                                  ),
                                                    ...
                                                    Flexible(
                                                      ...
                                                      child: Container(
                                                        ...
                                                        child: Column(
                                                          ...
                                                          mainAxisAlignment: MainAxisAlignment.center,
                                                          children: [
                                                            items[index]["benname"] == null ? Text("") : Text(items[index]["benname"],
                                            ...
                                            Expanded(
                                              child: Container(
                                                ...
                                                child: Column(
                                                  crossAxisAlignment: CrossAxisAlignment.end,
                                                  children: [
                                                    Text(getTranslated(context, 'My Earn'),style: TextStyle(fontSize: 12),overflow: TextOverflow.ellipsis,),
                                                    SizedBox(height: 1,),
                                                    Text("\u{20B9} " + items[index]["rem_comm"].toString(),style: TextStyle(fontWeight: FontWeight.bold),textAlign: TextAlign.right,)
                                                  ],
                                                ),
                                              ),
                                            )
                                                        ...
                                                        child: Container(
                                                          ...
                                                          child: Column(
                                                            children: [
                                                              ...
                                                              SizedBox(height: 1,),
                                                              Text(items[index]["bankrrn"].toString(),textAlign: TextAlign.right,)
                                                            ],
                                                          ),
                                                        ),
                                                      ),
                                                          ...
                                                          child: Column(
                                                            ...
                                                            children: [
                                                              Text(
                                                                ...
                                                                overflow: TextOverflow.ellipsis,softWrap: true,textAlign: TextAlign.right,),
                                                              SizedBox(height: 1,),
                                                              Text(items[index]["reqid"],textAlign: TextAlign.right,)
                                                            ],
                                                          ),
                                                        ),
                                                      ),
                                                        ...
                                                        child: Container(
                                                          ...
                                                          child: Column(
                                                            ...
                                                            children: [
                                                              ...
                                                              SizedBox(height: 1,),
                                                              Text("\u{20B9} " + items[index]["Rem_pre"].toString(),textAlign: TextAlign.right,)
                                                            ],
                                                          ),
                                                        ),
                                                      ),
                                                        ...
                                                        child: Container(
                                                          ...
                                                          child: Column(
                                                            children: [
                                                              ...
                                                              SizedBox(height: 1,),
                                                              Text("\u{20B9}" + items[index]["rem_post"].toString(),textAlign: TextAlign.right,)
                                                            ],
                                                          ),
                                                        ),
                                                      ),
                                                        ...
                                                        child: Container(
                                                          ...
                                                          child: Column(
                                                            ...
                                                            children: [
                                                              ...
                                                              SizedBox(height: 1,),
                                                              Text("\u{20B9} " + items[index]["rem_gst"].toString(),textAlign: TextAlign.right,)
                                                            ],
                                                          ),
                                                        ),
                                                      ),
                                                        ...
                                                        child: Container(
                                                          ...
                                                          child: Column(
                                                            children: [
                                                              ...
                                                              SizedBox(height: 1,),
                                                              Text("\u{20B9} "+items[index]["rem_tds"].toString(),textAlign: TextAlign.right,)
                                                            ],
                                                          ),
                                                        ),
                                                      ),
