...
class RToRFundReport extends StatefulWidget {
  const RToRFundReport({Key key}) : super(key: key);

  @override
  _RToRFundReportState createState() => _RToRFundReportState();
}

class _RToRFundReportState extends State<RToRFundReport> {
 ...
 DateTime selectedDate2 = DateTime.now();
  ...
  Future<void> rtorReport( String frmDate, String toDate, String id) async {
    final storage = new FlutterSecureStorage();
    var a = await storage.read(key: "accessToken");

    String token = a;
    var url =
    new Uri.http("api.vastwebindia.com", "/Retailer/api/data/rem_rem_fund_transfer_report", {
  ...
  Future<void> initState()  {
    ...
    super.initState();
        ...
        rtorReport(frmDate,toDate,retailerId);
  ...
  Widget build(BuildContext context) {
    return SimpleAppBarWidget(
      title: Align(
          ...
          child: Text(getTranslated(context, 'R To R History'),style: TextStyle(color: TextColor),textAlign: TextAlign.center,)),
                                          ...
                                          children: [
                                            Column(
                                              ...
                                              children: [
                                                  ...
                                                  Text (inforeport[index]["transfertoretailername"] == null ? "..." :inforeport[index]["transfertoretailername"],style: TextStyle(fontSize: 12,fontWeight: FontWeight.bold),),
                                              ],
                                            ),
                                            Column(
                                              ...
                                              children: [
                                                  ...
                                                  Text (inforeport[index]["tran_date"] == null ? "0 0 0" :inforeport[index]["tran_date"],style: TextStyle(fontSize: 12,fontWeight: FontWeight.bold),),
                                        ...
                                        children: [
                                            ...
                                            child: Container(
                                              child: Column(
                                                ...
                                                children: [
                                                  ...
                                                  Text(
                                                    "\u{20B9} " + inforeport[index]["rem_from_old_bal"].toString(),
                                          ...
                                          Expanded(
                                            child: Container(
                                              decoration: BoxDecoration(
                                                  border: Border(
                                                      left: BorderSide(color: PrimaryColor.withOpacity(0.1), width: 1,),
                                                      right: BorderSide(color: PrimaryColor.withOpacity(0.1), width: 1,),
                                                  )
                                              ),
                                              child: Column(
                                                ...
                                                children: [
                                                  ...
                                                  Text("\u{20B9} " + inforeport[index]["rem_from_new"].toString(),style: TextStyle(fontSize: 12,fontWeight: FontWeight.bold),textAlign: TextAlign.right,)
                                                ],
                                              ),
                                            ),
                                          ),
                                            ...
                                            child: Container(
                                              child: Column(
                                                ...
                                                children: [
                                                  ...
                                                  Text("\u{20B9} " + inforeport[index]["value"].toString(),style: TextStyle(fontSize: 12,fontWeight: FontWeight.bold),textAlign: TextAlign.center,)
                                                ],
                                              ),
                                            ),
                                          ),
