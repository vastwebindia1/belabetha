...
class RetailerIncomeReport extends StatefulWidget {
  const RetailerIncomeReport({Key key}) : super(key: key);

  @override
  _RetailerIncomeReportState createState() => _RetailerIncomeReportState();
}

class _RetailerIncomeReportState extends State<RetailerIncomeReport> {
  ...
  Future<void> retailerIncomeReport( String frmDate) async {
    final storage = new FlutterSecureStorage();
    var a = await storage.read(key: "accessToken");

    String token = a;
    var url =
    new Uri.http("api.vastwebindia.com", "/Retailer/api/data/ShowActualIncome",{
      "from":frmDate,
                                                  ...
                                                  children: [
                                                    Container(
                                                      ...
                                                      child: CircleAvatar(
                                                          ...
                                                          child: inforeport[index]["Type"] == "Aeps" ?
                                          ...
                                          children: [
                                            ...
                                            Expanded(
                                              child: Container(
                                                ...
                                                child: Column(
                                                  children: [
                                                    Text(getTranslated(context, 'Total Pending'),style: TextStyle(fontSize: 12),maxLines: 1,overflow: TextOverflow.ellipsis,),
                                                    SizedBox(height: 1,),
