...
class RetailerDayBook extends StatefulWidget {
  const RetailerDayBook({Key key}) : super(key: key);

  @override
  _RetailerDayBookState createState() => _RetailerDayBookState();
}

class _RetailerDayBookState extends State<RetailerDayBook> {
  ...
  Future<void> retailerDayBook( String frmDate, String toDate) async {
    final storage = new FlutterSecureStorage();
    var a = await storage.read(key: "accessToken");

    String token = a;
    var url =
    new Uri.http("api.vastwebindia.com", "/Retailer/api/data/Retailerdaybook",{
      "from":frmDate,
      "to":toDate,
    ...
    if (response.statusCode == 200) {
      ...
      var report1 = data["data"];
      duration = data["durations"].toString();
  ...
  void initState() {
    ...
    retailerDayBook(frmDate,toDate);
  }
  @override
                                                        ...
                                                        children: [
                                                          Column(
                                                            ...
                                                            children: [
                                                              ...
                                                              Text(duration + "Days",style: TextStyle(fontSize: 12,fontWeight: FontWeight.bold),)
                                                            ],
                                                          ),
                                                        ],
                                                      ),
...
class AppBarWidgetTwoSide extends StatefulWidget {

  final body;
  final Widget title;
  const AppBarWidgetTwoSide({
    key, this.body, this.title,
  }) : super(key: key);

  @override
  _AppBarWidgetTwoSideState createState() => _AppBarWidgetTwoSideState();
}
class _AppBarWidgetTwoSideState extends State<AppBarWidgetTwoSide> {
  @override
  Widget build(BuildContext context) {
    return Material(
      color: PrimaryColor,
