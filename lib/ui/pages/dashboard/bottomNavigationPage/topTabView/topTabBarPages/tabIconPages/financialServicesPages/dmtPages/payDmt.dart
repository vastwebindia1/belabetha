...
class DmtPay extends StatefulWidget {
  final String bankname,accnum,ifscc,remid,mode,name,uniqueid;
  const DmtPay({Key key, this.bankname, this.accnum, this.ifscc, this.remid, this.mode, this.name, this.uniqueid}) : super(key: key);

  @override
  _DmtPayState createState() => _DmtPayState();
}

class _DmtPayState extends State<DmtPay> {
  ...
  Future<void> sendmoneyapi(String userid, String num, String ifsc, String benefiid,String amunt,String dmtpin,String accno,String mode,String devicid,String bnkname, String ipaddr, String lat,String long, String model,String address,String city, String postcode,String intype,String key, String iv) async {
    ...
    try{
                      ...
                      child: FlatButton(
                          onPressed: (){
                            Navigator.pushReplacement(
                                context,
                                MaterialPageRoute(
                                    builder: (context) => Impshistorypage()));
      ...
      if (response.statusCode == 200) {
        ...
        Navigator.push(context, MaterialPageRoute(builder: (context) => paymentresponse(bankname: bnknamee,accnum:acccno ,bankrrn: bnkrrid,status: statuss,ifsc: ifscodee,date: dateortime,mode: widget.mode,amount: amountt,sservicefee: servicefee.text,name: widget.name,)),);
  ...
  _pickImageFromCamera3() async {
   ...
   try{
     ...
     sendmoneydetails2(sendnum, widget.ifscc, "123456", amount.text, transpin.text, widget.accnum, widget.mode, androidid, widget.bankname, ipadd, lat, long, modelname, address, city, postcode, netname);
                          ...
                          children: [
                              ...
                              children: [
                                Row(
                                  ...
                                  children: [
                                    ...
                                    SizedBox(
                                      width: 24,
                                      child: widget.mode == "IMPS" ? Image(
                                        image: AssetImage("assets/pngImages/money-transfer.png",),
                                      ): Icon(Icons.account_balance_sharp,color: PrimaryColor,size: 22,),
                                    ),
                                    Text(widget.mode,textAlign: TextAlign.left,
                                      style: TextStyle(
                                          fontSize: 24,
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                Flexible(
                                  child: Text(" : " + widget.bankname,textAlign: TextAlign.left,
                                    style: TextStyle(
                                        fontSize: 16,
                                        fontWeight: FontWeight.bold,
                                        letterSpacing: 1,
                            ...
                            Row(
                              ...
                              children: [
                                Row(
                                  children: [
                                    Text(getTranslated(context, 'Ac'),
                                      textAlign: TextAlign.left,
                                      style: TextStyle(fontSize: 16,color: PrimaryColor,fontWeight: FontWeight.bold,),),
                                    Text(" : " +widget.accnum.toUpperCase(),
                                      textAlign: TextAlign.left,
                                      style: TextStyle(fontSize: 16,color: PrimaryColor,fontWeight: FontWeight.bold,),),
                                  ],
                                ),
                            ...
                            Expanded(
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Container(
                                    width: 50,
                                    child: Text(getTranslated(context, 'pancard'),
                                      style: new TextStyle(
                                          fontSize: 12,
                                          color: TextColor
                                      ),
                        ...
                        if(adhrrr == "true"  && aadharnaun < 12){
                          ...
                          if(enteramnt != reenteramntt){
                           ...
                           /* setState(() {
                            ...
                            sendmoneydetails(sendnum, widget.ifscc, "123456", amount.text, transpin.text, widget.accnum, widget.mode, androidid, widget.bankname, ipadd, lat, long, modelname, address, city, postcode, netname);
