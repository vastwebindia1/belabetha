...
class paymentresponse extends StatefulWidget {
  ...
  const paymentresponse({Key key, this.bankname, this.accnum, this.ifsc, this.date, this.status, this.bankrrn, this.mode, this.amount, this.sservicefee, this.name}) : super(key: key);
                      ...
                      child: Container(
                        child: Column(
                          children: [
                            ...
                            Container(
                              margin: EdgeInsets.only(left: 10,right: 10,top: 10),
                              child: Text("TRANSACTION " + widget.status.toUpperCase(),style: TextStyle(fontSize: 32,fontWeight: FontWeight.bold,color:widget.status == getTranslated(context, 'Failed') ? Colors.red:widget.status == getTranslated(context, 'Success') ? Colors.green:Colors.yellow),textAlign: TextAlign.center,),
                            ),
                            Container(
                              height: 2,
                              ...
                              child: Column(
                                children: [
                                  Row(
                                    ...
                                    children: [
                                      Text(getTranslated(context, 'Account No'),
                                  ...
                                  Row(
                                    ...
                                    crossAxisAlignment: CrossAxisAlignment.center,
                                    children: [
                                      Text(getTranslated(context, 'acHolder'),
                                        textAlign: TextAlign.left,
                                        style: TextStyle(fontSize: 16,color: PrimaryColor,fontWeight: FontWeight.bold,),),
                                      Expanded(
                                  ...
                                  Row(
                                    ...
                                    crossAxisAlignment: CrossAxisAlignment.center,
                                    children: [
                                      Text(getTranslated(context, 'Ifsc') ,
                                        textAlign: TextAlign.left,
                                        style: TextStyle(fontSize: 16,color: PrimaryColor,fontWeight: FontWeight.bold,),),
                                      Expanded(
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      Text(getTranslated(context, 'Bank RRN'),
                                        ...
                                        Expanded(
                                        child: Text(widget.bankrrn,textAlign: TextAlign.right,
                                          style: TextStyle(
                                              fontSize: 16,
                                              fontWeight: FontWeight.bold,
                                              letterSpacing: 1,
                          ...
                          SizedBox(
                            ...
                            child: FlatButton(
                              ...
                              onPressed: (){
                                ...
                                Navigator.pushReplacement(
                                  context, MaterialPageRoute(builder: (context) => RegisterSenderPage()),);
