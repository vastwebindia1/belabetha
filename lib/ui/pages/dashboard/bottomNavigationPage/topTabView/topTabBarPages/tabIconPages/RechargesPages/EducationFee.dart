...
class EducationState extends State<EducationPage> {
  ...
  List statelistt = [];
  List citylist = [];
  String Educationoperator = "Select Institute";
  String district ="District";
  String statett = "Select State";
  String firsttexthint = "Consumer No";
  String accnumhint = "Agency Code";
  String accnumhint2 = "Agency Code";
  String disid,stateid;
  String Educationoptcode,duedate,rechargeamnt,customerstatus,balance;
  ...
  Future<void> statelist() async {
    ...
    var url1 = new Uri.http("api.vastwebindia.com", "/Recharge/api/data/EducationStatelist");
  ...
  Future<void> ctylist(String id) async {
    final storage = new FlutterSecureStorage();
    var token = await storage.read(key: "accessToken");

    var url1 = new Uri.http("api.vastwebindia.com", "/Recharge/api/data/EducationCitybasedstate", {
      "stateids": id,
    });
    final http.Response response = await http.get(
      url1,
  ...
  Future<void> educoptlist(String state, String dist) async {
    ...
    var uri = new Uri.http("api.vastwebindia.com", "/Recharge/api/data/GetALLEduInsitutelist", {
      "stateid": state,
      "cityid": dist,
  ...
  Future<void> Educationrechtask(String id, String num, String opt, String amnt, String lat,String long, String city,String address, String pin,String intype,String ipadd,String model,String key, String iv) async {
    final storage = new FlutterSecureStorage();
    var token = await storage.read(key: "accessToken");
      ...
      if (response.statusCode == 200) {
        ...
        if(status == "Success"){
          ...
          CoolAlert.show(
            ...
            onConfirmBtnTap: (){
              Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => EducationPage()));
            },
          );
                      ...
                      child: Container(
                        child: ListView.builder(
                          ...
                          itemBuilder: (context,  index) {
                                      ...
                                      Expanded(
                                        child: TextButton(
                                          ...
                                          onPressed: (){
                                            ...
                                            int idd = statelistt[index]["idno"];
                                            stateid = idd.toString();
                                            ctylist(stateid);
                                            statett = statelistt[index]["statelist"];
                                            Navigator.of(context).pop();
                                          },
                                          child: Container(
                                            alignment: Alignment.centerLeft,
                                            child: Text(statelistt[index]["statelist"],textAlign: TextAlign.left,style: TextStyle(color: PrimaryColor),),
                                          ),
                                        ),
                                      ),
                                    ],
                            ...
                            } else if (statelistt[index]["statelist"]
                                .toLowerCase()
                                .contains(_textController.text) || statelistt[index]["statelist"]
                                .toUpperCase()
                      ...
                      child: Container(
                        child: ListView.builder(
                          ...
                          itemBuilder: (context,  index) {
                                      ...
                                      Expanded(
                                        child: TextButton(
                                          ...
                                          onPressed: (){
                                            ...
                                            setState(() {
                                              operatordilvis = true;
                                              disid = citylist[index]["CityID"];
                                              educoptlist(stateid,disid);
                                              _textController.clear();
                                              district = citylist[index]["CityName"];
                                              Navigator.of(context).pop();
                                            });
                                          ...
                                          child: Container(
                                            alignment: Alignment.centerLeft,
                                            child: Text(citylist[index]["CityName"],textAlign: TextAlign.left,style: TextStyle(color: PrimaryColor),),
                                          ),
                                        ),
                                      ),
                                    ],
                            ...
                            } else if (citylist[index]["CityName"]
                                .toLowerCase()
                                .contains(_textController.text) || citylist[index]["CityName"]
                                .toUpperCase()
                                .contains(_textController.text)) {
                              return Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                      ...
                      child: Container(
                        child: ListView.builder(
                          ...
                          itemBuilder: (context,  index) {
                                        ...
                                        child: TextButton(
                                          ...
                                          onPressed: (){
                                            ...
                                            setState(() {
                                              ...
                                              numberenable = true;
                                              custominfolay1 = false;
                                              Educationoperator = operatorlisr[index]["blr_name"];
                                              Educationoptcode  = operatorlisr[index]["blr_id"];


                                              String yyy = operatorlisr[index]["blr_customer_params"];


                                              custparam = json.decode(yyy);
                                                ...
                                                if(custparam.length == 2){
                                                  ...
                                                  setState(() {
                                                    ...
                                                    if(key2 == "ALPHANUMERIC"){
                                                      ...
                                                      setState(() {
                                                        keytyp2 = TextInputType.datetime;
                                                      });
                                                    }
                                                  ...
                                                  setState(() {
                                                    ...
                                                    if(key3 == "ALPHANUMERIC"){
                                                      ...
                                                      setState(() {
                                                        keytyp3 = TextInputType.datetime;
                                                      });
                                                    }
                                                  });
                                              ...
                                              _textController.clear();
                                              viewbillstatuscheck(Educationoptcode);
                                              Navigator.of(context).pop();
                                            });
                                          },
                                          child: Container(
                                            alignment: Alignment.centerLeft,
                                            child: Text(operatorlisr[index]["blr_name"],textAlign: TextAlign.left,style: TextStyle(color: PrimaryColor),),
                                          ),
                                        ),
                                      ),
                                    ],
                            ...
                            } else if (operatorlisr[index]["blr_name"]
                                .toLowerCase()
                                .contains(_textController.text) || operatorlisr[index]["blr_name"]
                                .toUpperCase()
                                .contains(_textController.text)) {
                              return Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
  ...
  Widget build(BuildContext context) {
    ...
    return AppBarWidget(
        title: CenterAppbarTitle(
          ...
          selectedItemName:getTranslated(context, 'Education Fee'),
        ),
                    ...
                    child: OutlineButton(
                      ...
                      child: Container(
                        child: Row(
                          children: [
                            Expanded(
                                child: Text(statett  +", " + district,
                              style: TextStyle(color: PrimaryColor,fontWeight: FontWeight.normal,fontSize: 18),overflow: TextOverflow.ellipsis,)),
                    ...
                    child: Container(
                      ...
                      child: OutlineButton(
                        ...
                        child: Container(
                          child: Row(
                            children: [
                              Expanded(child: Text(Educationoperator,
                                style: TextStyle(color: PrimaryColor,fontWeight: FontWeight.normal,fontSize: 18),overflow: TextOverflow.ellipsis,)),
                              SizedBox(width: 20,child: Icon(Icons.arrow_drop_down,color: PrimaryColor,),)
                            ],
                          ),
                              ...
                              child: Container(
                                  ...
                                  child: TextButton(
                                    ...
                                    onPressed: () {
                                      ...
                                      viewbill(consumernumber.text,Educationoptcode,agencycode.text);
                                    },
                                  ))
                          ),
                        ),
                        ...
                        showDialog(
                            ...
                            context) {
                              return CustomDialogWidget(
                                ...
                                description01: Educationoperator ,textStyle: TextStyle(fontSize: 32.0,fontWeight: FontWeight.w800),
                                ...
                                onpress2: (){
                                  ...
                                  Navigator.of(context).pop();
                                  Educationrechdetails(consumernumber.text,Educationoptcode,amount.text,lat,long,city,address,postcode,netname,ipadd,androidid);
                                },
                                onpress: (){
  ...
  void Educationrechdetails(String number, String operator, String amnt, String lat,String long, String city, String address,String pascode, String contype, String ipadd, String andid) async{
    ...
    Educationrechtask(useridd,numberr,opert,amnt,lat1,long1,city1,addre1,pascode1,cont1,ipd1,andiddd,keyencoded,viencoded);
