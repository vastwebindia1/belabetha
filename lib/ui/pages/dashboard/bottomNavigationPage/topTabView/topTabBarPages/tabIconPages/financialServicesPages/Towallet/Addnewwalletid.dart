...
class _AddnewwalletState extends State<Addnewwallet> {
  ...
  Future<void> addbeneficiary(String sendnum, String upiid, String name) async {
    ...
    var url = new Uri.http("api.vastwebindia.com", "/WALLET/api/WALLET/RegisterBeneficiary", {
      "senderno": sendnum,
      "account": upiid,
      "benname":name,
    });
    ...
    if (response.statusCode == 200) {
      ...
      if(result == "0"){
        ...
        CoolAlert.show(
          ...
          text: "Wallet ID Add Successfully",
          confirmBtnText: 'OK',
                        ...
                        Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              SizedBox(width: 5,),
                              Text("ADD Wallet ID",style: TextStyle(color: TextColor,fontWeight: FontWeight.bold,fontSize: 18),),
                            ],
                          ),
                        ),
                  ...
                  Visibility(
                    ...
                    child: MainButtonSecodn(
                        onPressed:() async{
                          ...
                          int walletid = vpaidcont.text.length;

                          if(walletid < 10){

                            final snackBar2 = SnackBar(
                              backgroundColor: Colors.red[900],
                              content: Text("Enter Valid Wallet ID",style: TextStyle(color: Colors.yellowAccent),textAlign: TextAlign.center),
                            );
                        ...
                        btnText:Row(
                          ...
                          children: [
                            Expanded(
                                ...
                                ),) : Text("Add Wallet ID",style: TextStyle(color: TextColor),textAlign: TextAlign.center,)
                            ),
                          ],
                        )
                    ),),
                          ...
                          children: [
                            Expanded(
                                child: _isloading ? Center(child: SizedBox(
                                  height: 20,
                                  child: LinearProgressIndicator(backgroundColor: PrimaryColor,valueColor: AlwaysStoppedAnimation<Color>(Colors.white),),
                                ),) : Text("Verify Wallet ID",style: TextStyle(color: TextColor),textAlign: TextAlign.center,)
                            ),
                          ],
                        )
                    ),),
