...
class HospitalPagestate extends State<HospitalPage> {
  ...
  List operatorlisr = [];
  List custparam = [];
  String hospitaloperator = "Select Operator";
  String firsttexthint = "Consumer No";
  String accnumhint = "Agency Code";
  String accnumhint2 = "Agency Code";
  String hospitaloptcode,duedate,rechargeamnt,customerstatus,balance;
  ...
  Future<void> hospitalrechtask(String id, String num, String opt, String amnt, String lat,String long, String city,String address, String pin,String intype,String ipadd,String model,String key, String iv) async {
    final storage = new FlutterSecureStorage();
    var token = await storage.read(key: "accessToken");
      ...
      if (response.statusCode == 200) {
        ...
        if(status == "Success"){
          ...
          CoolAlert.show(
            ...
            onConfirmBtnTap: (){
              Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => HospitalPage()));
            },
          );
                                        ...
                                        child: TextButton(
                                          ...
                                          onPressed: (){
                                            ...
                                            setState(() {
                                              ...
                                              numberenable = true;
                                              custominfolay1 = false;
                                              hospitaloperator = operatorlisr[index]["Operatorname"];
                                              hospitaloptcode  = operatorlisr[index]["OPtCode"];
                                              ...
                                              viewbillstatuscheck(hospitaloptcode);
  ...
  void initState() {
    ...
    super.initState();
    operatorlist("Hospital and Pathology");
  }
  ...
  Widget build(BuildContext context) {
    return AppBarWidget(
        title: CenterAppbarTitle(
          ...
          selectedItemName:getTranslated(context, 'Hospital'),
        ),
              ...
              child: Column(
                children: [
                  ...
                  Container(
                    margin: EdgeInsets.only(left: 10,right: 10),
                    child: OutlineButton(
                      onPressed:hospitaloperatordialog,
                      ...
                      child: Container(
                        child: Row(
                          children: [
                            Expanded(child: Text(hospitaloperator,style: TextStyle(color: PrimaryColor,fontWeight: FontWeight.normal,fontSize: 18),overflow: TextOverflow.ellipsis,)),
                              ...
                              child: Container(
                                  ...
                                  child: TextButton(
                                    ...
                                    onPressed: () {
                                      ...
                                      viewbill(consumernumber.text,hospitaloptcode,agencycode.text);
                                    },
                                  ))
                          ),
                        ),
                        ...
                        showDialog(
                            ...
                            context) {
                              return CustomDialogWidget(
                                ...
                                description01: hospitaloperator ,textStyle: TextStyle(fontSize: 32.0,fontWeight: FontWeight.w800),
                                ...
                                onpress2: (){
                                  ...
                                  Navigator.of(context).pop();
                                  hospitalrechdetails(consumernumber.text,hospitaloptcode,amount.text,lat,long,city,address,postcode,netname,ipadd,androidid);
                                },
                                onpress: (){
  ...
  void hospitalrechdetails(String number, String operator, String amnt, String lat,String long, String city, String address,String pascode, String contype, String ipadd, String andid) async{
    ...
    hospitalrechtask(useridd,numberr,opert,amnt,lat1,long1,city1,addre1,pascode1,cont1,ipd1,andiddd,keyencoded,viencoded);
