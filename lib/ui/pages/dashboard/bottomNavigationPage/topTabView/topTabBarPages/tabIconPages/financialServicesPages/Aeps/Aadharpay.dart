...
import 'aepscheckbalance.dart';
import 'dart:io' as Io;


class Aadharpay extends StatefulWidget {
  final String name,number,aadhrnum;
  const Aadharpay({Key key, this.name, this.number, this.aadhrnum}) : super(key: key);

  @override
  _AadharpayState createState() => _AadharpayState();
}
...
class _AadharpayState extends State<Aadharpay> {
  ...
  Future<void> aadhapaycash(var captures, var cardnum, String otp) async {

    final storage = new FlutterSecureStorage();
    var token = await storage.read(key: "accessToken");

    var url = new Uri.http("api.vastwebindia.com", "/AEPS/api/app/Aeps/Aadharpay");
    Map map = {
    ...
    debugPrint('otppp:$otp');
    debugPrint('dddfdfef:$body');
  ...
  Future<void> responseFromNativeCode2() async  {
    ...
    try {
      ...
      setState(() {
        ...
        aadhapaycash(dddfe,dsdsd,otpcontroller.text);
  ...
  Future<void> sendotp(String amount, String mobi) async {

    final storage = new FlutterSecureStorage();
    var token = await storage.read(key: "accessToken");

    var url = new Uri.http("api.vastwebindia.com", "/AEPS/api/app/Aeps/AadharpayGenrateOtp",{
                            ...
                            child: Container(
                              ...
                              child: Row(
                                children: [
                                  ...
                                  Text(getTranslated(context, 'Aadhar Pay Receipt'),
                                    style:
  ...
  Widget build(BuildContext context) {
    ...
    return AppBarWidget3(
      title: AepsAppbarTitle(
        svgImage: 'assets/pngImages/Aadhaar-Pay.png',
        topText:getTranslated(context, 'Aeps'),
        selectedItemName:getTranslated(context, 'Aadhar Pay'),
      ),
      body: Container(
        child: SingleChildScrollView(
          child: SafeArea(
            child: Column(
              children: [
                  ...
                  child: Visibility(
                    ...
                    child: MainButtonSecodn(
                      onPressed:() async{
                        ...
                        if(mobile < 10){
                          ...
                          sendotp(amountcont.text, mobilenum.text);
                    ...
                    replacement: MainButtonSecodn(
                      onPressed:() async{
                        ...
                        }else if(otpservisi == true){

                          if(otpcontroller.text == "" || otp < 4) {
                            setState(() {
                              _otpcont = true;
                            });
                            ...
                            final snackBar2 = SnackBar(
                              backgroundColor: Colors.red[900],
                              content: Text(getTranslated(context, 'Enter Valid OTP'),
                ...
                Container(
                  ...
                  child: Text(getTranslated(context, 'modechange'),style: TextStyle(color:SecondaryColor,fontSize: 10,fontWeight: FontWeight.w500,),textAlign: TextAlign.center,),
                ),
                Container(
                        ...
                        children: [
                          GestureDetector(
                            onTap: (){
                                ...
                                context,
                                PageRouteBuilder(
                                pageBuilder: (context, animation1, animation2) =>Ministatement(name: consumername.text,aadhrnum: aadharnum.text,number: mobilenum.text,),
                                transitionDuration: Duration(seconds: 0),
                                ),);
                                },
                            ...
                            child: Container(
                                ...
                                child: Text(getTranslated(context, 'Mini-Statement'),style: TextStyle(color: TextColor,fontSize: 12),)
                            ),
                          ),
                          SizedBox(
                            width: 5,
                          ...
                          GestureDetector(
                            onTap: (){
                              ...
                              Navigator.pushReplacement(
                                context,
                                PageRouteBuilder(
                                  pageBuilder: (context, animation1, animation2) => Aepscheckbalance(name: consumername.text,aadhrnum: aadharnum.text,number: mobilenum.text,),
                                  transitionDuration: Duration(seconds: 0),
                                ),);
