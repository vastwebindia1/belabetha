...
class Purchasemainpage extends StatefulWidget {
  ...
  @override
  _PurchasemainpageState createState() => _PurchasemainpageState();
}
            ...
            child: Column(
              children: [
                                        ...
                                        child: Column(
                                          children: [
                                            Container(
                                              ...
                                              child: Image.asset('assets/pngImages/Pos.png'),
                                            ),
                                            SizedBox(height: 5,),
                                            Text(getTranslated(context, 'Purchase'),style: TextStyle(color: TextColor,fontSize: 18,),)
                                          ],
                                        ),
                                      ),
                                    ],
                ...
                Container(
                  ...
                  child: Text("1 On purchase and sale transactions, the bank will require a challan if the amount exceeds Rs.10,000/-.",textAlign: TextAlign.justify,),
                ),
                SizedBox(
                  height: 20,
                ),
                        ...
                        child: OutlinedButton(
                          style: OutlinedButton.styleFrom(
                            ...
                            onPressed:btnclick == false ? null :()async{
                              ...
                              Apitransitionsencrypt(trnsidd, amount.text, ipadd, "purchase", lat, long, modelname, city, postcode, netname, address);
