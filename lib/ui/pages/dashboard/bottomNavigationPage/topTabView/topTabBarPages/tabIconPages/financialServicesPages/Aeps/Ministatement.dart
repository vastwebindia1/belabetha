...
class Ministatement extends StatefulWidget {
  ...
  const Ministatement({Key key, this.name, this.number, this.aadhrnum}) : super(key: key);
...
class _MinistatementState extends State<Ministatement> {
  ...
  Future<void> ministatement(var captures, var cardnum) async {

    final storage = new FlutterSecureStorage();
    var token = await storage.read(key: "accessToken");

    var url = new Uri.http("api.vastwebindia.com", "/AEPS/api/app/AEPS/MiniStatement");
    Map map = {
    ...
    debugPrint('chedhdhddddddddminisdataa$body');
    ...
    if (response.statusCode == 200) {
      ...
      debugPrint('chedhdhminisdataa$dataa');
        ...
        builder: (BuildContext context) {
          return RepaintBoundary(
            ...
            child: Container(
              ...
              child: AlertDialog(
                insetPadding: EdgeInsets.only(right: 2, left: 0,top: 38,),
                            ...
                            child: Container(
                              ...
                              child: Row(
                                children: [
                                  ...
                                  Text(
                                    'Mini Statement Receipt'.toUpperCase(),
                                    style:
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Row(
                                        ...
                                        children: [
                                          Expanded(child: Text(statment[index]["Date"].toString(),style: TextStyle(fontSize: 12),),),
                                          Expanded(child: Text(statment[index]["openbal"].toString(),style: TextStyle(fontSize: 12),),),
                                          Expanded(child: Text(statment[index]["Type"].toString(),style: TextStyle(fontSize: 12),),),
                                          Expanded(child: Text(statment[index]["Amount"].toString(),style: TextStyle(fontSize: 12),),),
                                          Expanded(child: Text(statment[index]["closebal"].toString(),style: TextStyle(fontSize: 12),),)
                                        ],
                                      ),
  ...
  Widget build(BuildContext context) {
    ...
    return AppBarWidget3(
      title: AepsAppbarTitle(
        svgImage: 'assets/pngImages/Mini-ststment.png',
        topText:getTranslated(context, 'Aeps'),
        selectedItemName: "Mini-Statement",
      ),
      body: Container(
        child: SingleChildScrollView(
          child: SafeArea(
                  ...
                  btnText:Row(
                    ...
                    children: [
                      Expanded(
                          ...
                          ),) : Text(getTranslated(context, 'Check Mini-Statement'),textAlign: TextAlign.center,style: TextStyle(color: TextColor),)
                      ),
                    ],
                  ),
                ),
                        ...
                        children: [
                          GestureDetector(
                            ...
                            child: Container(
                                ...
                                child: Text(getTranslated(context, 'Cash Withdrawal'),style: TextStyle(color: TextColor,fontSize: 12),)
                            ),
                          ),
                          SizedBox(
                            width: 5,
