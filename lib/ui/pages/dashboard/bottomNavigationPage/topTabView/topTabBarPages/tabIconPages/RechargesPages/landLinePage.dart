...
class LandLinePage extends StatefulWidget {
  const LandLinePage({Key key}) : super(key: key);

  @override
  _LandLinePageState createState() => _LandLinePageState();
}

class _LandLinePageState extends State<LandLinePage> {
  ...
  bool landcustominfolay1 = false;
  bool landnodatalay = false;
  bool loader = false;
  ...
  List landoperatorlist = [];
  List custparam = [];
  String landlinecode,billamnt,billduedate,customername;
  String msz ="";
  String landlineopt = "Select Landline Operator";

  String firsttexthint = "Number";
  String accnumhint = "Account Number";
  String netname, ipadd, modelname, androidid, lat, long, city, address, postcode,status;

  final TextEditingController landconsumernumber = TextEditingController();
  final TextEditingController landamount = TextEditingController();
  ...
  Future<void> landrechtask(String id, String num, String opt, String amnt, String lat,String long, String city,String address, String pin,String intype,String ipadd,String model,String key, String iv) async {
    final storage = new FlutterSecureStorage();
    var token = await storage.read(key: "accessToken");
    ...
    if (response.statusCode == 200) {
      ...
      if(status.contains("true")){
        ...
        setState(() {
          ...
          customername;
          btndisable = true;
          landamount.text = billamnt;
          landnodatalay = false;
          landcustominfolay1 = true;
        });
                    ...
                    child: SingleChildScrollView(
                      child: Container(
                        child: ListView.builder(
                          ...
                          itemCount: landoperatorlist.length,
                          itemBuilder: (context,  index) {
                                      ...
                                      Expanded(
                                        child: TextButton(
                                          ...
                                          onPressed: (){
                                            ...
                                            setState(() {
                                              landamount.clear();
                                              landconsumernumber.clear();
                                              landnodatalay = false;
                                              numberenable = true;
                                              landcustominfolay1 = false;
                                              landlineopt = landoperatorlist[index]["Operatorname"];
                                              landlinecode  = landoperatorlist[index]["OPtCode"];

                                              custparam = landoperatorlist[index]["customerparams"];
                                              ...
                                              viewbillstatuscheck(landlinecode);
                                              Navigator.of(context).pop();
                                            });
                                          },
                                          child: Container(
                                            alignment: Alignment.centerLeft,
                                            child: Text(landoperatorlist[index]["Operatorname"],textAlign: TextAlign.left,style: TextStyle(color: PrimaryColor),),
                                          ),
                                        ),
                                      ),
                                    ],
                            ...
                            } else if (landoperatorlist[index]["Operatorname"]
                                .toLowerCase()
  ...
  Widget build(BuildContext context) {
    return AppBarWidget(
      title: CenterAppbarTitle(
        ...
        selectedItemName:getTranslated(context, 'LandLine Bill'),
      ),
                  ...
                  Container(
                    ...
                    child: OutlineButton(
                      ...
                      child: Container(
                        child: Row(
                          children: [
                            Expanded(child: Text(landlineopt,style: TextStyle(color: PrimaryColor,fontWeight: FontWeight.normal,fontSize: 18),overflow: TextOverflow.ellipsis,)),
                          ...
                          if(status == "Y") {
                            if (value.length == maxlength) {
                              setState(() {
                                ...
                                viewbill(landconsumernumber.text, landlinecode,
                                    accno.text);
                              });
                            } else {
                              setState(() {
                      ...
                      showDialog(
                          ...
                          context) {
                            return CustomDialogWidget(
                              ...
                              description0: landconsumernumber.text ,
                              description1:getTranslated(context, 'Operator Name'),
                              description01: landlineopt ,textStyle: TextStyle(fontSize: 32.0,fontWeight: FontWeight.w800),
                              description2:getTranslated(context, 'Recharge Amount'),
                              description02: landamount.text,
                              ...
                              onpress2: (){
                                ...
                                Navigator.of(context).pop();
                                landrechdetails(landconsumernumber.text,landlinecode,landamount.text,lat,long,city,address,postcode,netname,ipadd,androidid);
                              },
                              onpress: (){
  ...
  void landrechdetails(String number, String operator, String amnt, String lat,String long, String city, String address,String pascode, String contype, String ipadd, String andid) async{
    ...
    landrechtask(useridd,numberr,opert,amnt,lat1,long1,city1,addre1,pascode1,cont1,ipd1,andiddd,keyencoded,viencoded);
