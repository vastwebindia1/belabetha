...
class Loanpagestate extends State<Loanpage> {
  ...
  List operatorlisr = [];
  List custparam = [];
  String loanoperator = "Select Operator";
  String firsttexthint = "Consumer No";
  String accnumhint = "Agency Code";
  String accnumhint2 = "Agency Code";
  String loanoptcode,duedate,rechargeamnt,customerstatus,balance;
  ...
  Future<void> loanrechtask(String id, String num, String opt, String amnt, String lat,String long, String city,String address, String pin,String intype,String ipadd,String model,String key, String iv) async {
    final storage = new FlutterSecureStorage();
    var token = await storage.read(key: "accessToken");
                                        ...
                                        child: TextButton(
                                          ...
                                          onPressed: (){
                                            ...
                                            setState(() {
                                              ...
                                              numberenable = true;
                                              custominfolay1 = false;
                                              loanoperator = operatorlisr[index]["Operatorname"];
                                              loanoptcode  = operatorlisr[index]["OPtCode"];
                                              ...
                                              viewbillstatuscheck(loanoptcode);
                                              Navigator.of(context).pop();
                                            });
                                          },
                                          child: Container(
  ...
  Widget build(BuildContext context) {
    return AppBarWidget(
        title: CenterAppbarTitle(
          ...
          selectedItemName:getTranslated(context, 'Loan'),
        ),
                  ...
                  Container(
                    ...
                    child: OutlineButton(
                      ...
                      child: Container(
                        child: Row(
                          children: [
                            Expanded(child: Text(loanoperator,style: TextStyle(color: PrimaryColor,fontWeight: FontWeight.normal,fontSize: 18),overflow: TextOverflow.ellipsis,)),
                              ...
                              child: Container(
                                  ...
                                  child: TextButton(
                                    ...
                                    onPressed: () {
                                      ...
                                      viewbill(consumernumber.text,loanoptcode,agencycode.text);
                                    },
                                  ))
                          ),
                        ),
                        ...
                        showDialog(
                            ...
                            context) {
                              return CustomDialogWidget(
                                ...
                                description01: loanoperator ,textStyle: TextStyle(fontSize: 32.0,fontWeight: FontWeight.w800),
                                ...
                                onpress2: (){
                                  ...
                                  Navigator.of(context).pop();
                                  loanrechdetails(consumernumber.text,loanoptcode,amount.text,lat,long,city,address,postcode,netname,ipadd,androidid);
                                },
                                onpress: (){
  ...
  void loanrechdetails(String number, String operator, String amnt, String lat,String long, String city, String address,String pascode, String contype, String ipadd, String andid) async{
    ...
    loanrechtask(useridd,numberr,opert,amnt,lat1,long1,city1,addre1,pascode1,cont1,ipd1,andiddd,keyencoded,viencoded);
