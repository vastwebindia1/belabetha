...
class RegisterSenderPage extends StatefulWidget {
  const RegisterSenderPage({Key key}) : super(key: key);

  @override
  _RegisterSenderPageState createState() => _RegisterSenderPageState();
}

class _RegisterSenderPageState extends State<RegisterSenderPage> {
  bool editText = false;
  bool loader = false;
  ...
  Future<void> remeterdetails(String number) async {
    ...
    if (response.statusCode == 200) {
      ...
      if (status == "TXN") {
        benelist = addinfo["data"]["beneficiary"];
  ...
  Future<void> deletebeneficiary(String number, String ifsc, String remid, String benid) async {
    final storage = new FlutterSecureStorage();
    var token = await storage.read(key: "accessToken");

    var url1 = new Uri.http(
        "api.vastwebindia.com", "/Money/api/Money/DeleteReceipent", {
      "mobile": number,
      "ifsc": ifsc,
      "code": "",
      "remitterid": remid,
    ...
    if (response.statusCode == 200) {
      ...
      if (result == "0") {
        ...
        Navigator.pushReplacement(
            context,
            MaterialPageRoute(
                builder: (context) => RegisterSenderPage()));
  ...
  Future<void> genuniqeid(String mode, String name, String bankname, String acc, String ifsc, String remid) async {
                                        ...
                                        Expanded(
                                          child: editText
                                            ...
                                            child: TextFormField(
                                              ...
                                              buildCounter: (BuildContextcontext, {
                                                    int currentLength,
                                                    int maxLength,
                                                    bool isFocused}) => null,
                                              ...
                                              onChanged: (value) {
                                                if (value.length == 10) {
                                                  ...
                                                  checksendernumber(editsennumber.text);
                                                } else {
                                                  setState(() {
                                                    loader = false;
                                                  });
                                        ...
                                        Container(
                                            ...
                                            child: TextButton(
                                              ...
                                              onPressed: () {
                                                Navigator.push(
                                                  context,
                                                  MaterialPageRoute(builder: (context) => Addnewbeneficiary()),
                                                );
                                              },
                                            )),
                                      ],
                                              ...
                                              Column(
                                                ...
                                                children: [
                                                  Column(
                                                    crossAxisAlignment: CrossAxisAlignment.start,
                                                    children: [
                                                      benificiarylist[index]["isverified"] == false ? Text(
                                                  ...
                                                  Text(benificiarylist[index]["name"]),
                                                ],
                                              ),
                                              Column(
                                                crossAxisAlignment: CrossAxisAlignment.end,
                                                children: [
                                                  Text(getTranslated(context, 'Bank AC No'),
                                                    style: TextStyle(
                                                        fontWeight:
                                                        FontWeight
                                              ...
                                              children: [
                                                Row(
                                                  ...
                                                  MainAxisAlignment
                                                      .spaceBetween,
                                                  children: [
                                                    Text(getTranslated(context, 'Bank'),
                                                        style: TextStyle(
                                                            fontWeight:
                                                            FontWeight.bold)),
                                                    Expanded(
                                                        child: Text(
                                                          benificiarylist[index]
                                                          ["bank"],
                                                ...
                                                Visibility(
                                                    visible:benificiarylist[index]["isbankdown"] == false ? false :true,
                                                    child: Container(
                                                      margin: EdgeInsets.only(top: 5,left: 0),
                                                      child: Text("Note :- Currently the beneficiary bank's server is down or busy, please try after sometime.",style: TextStyle(color: Colors.red,fontSize: 12),),
                                                    ))
                                              ],
                                          ),
                                        ),
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            Column(
                                              ...
                                              mainAxisAlignment:MainAxisAlignment.spaceBetween,
                                              children: [
                                                Text(getTranslated(context, 'IFS Code'),
                                                    style: TextStyle(
                                                        fontWeight:
                                                        FontWeight.bold)),
                                                Text(benificiarylist[index]
                                            ...
                                            TextButton(
                                              ...
                                              onPressed: () {
                                                ...
                                                mode = "IMPS";
                                                String name = benificiarylist[index]["name"];
                                                String bnkname = benificiarylist[index]["bank"];
                                                String acn = benificiarylist[index]["account"];
                                                String ifccode = benificiarylist[index]["ifsc"];
                                                String remid = benificiarylist[index]["id"];

                                                genuniqeid(mode,name,bnkname,acn,ifccode,remid);
                                              ...
                                              child: Column(
                                                children: [
                                                  SizedBox(
                                                    width: 16,
                                                    child: Image(
                                                      image: AssetImage("assets/pngImages/money-transfer.png",),
                                                    ),
                                                  ),
                                                  Text(getTranslated(context, 'IMPS'),
                                                    style: TextStyle(
                                                        color: color,
                                                        fontSize: 12),
                                                  )
                                            ...
                                            TextButton(
                                              ...
                                              child: Column(
                                                children: [
                                                  ...
                                                  Text(getTranslated(context, 'NEFT'),
                                                    style: TextStyle(
                                                        color: color,
                                                        fontSize: 12),
                                                  )
                                            ...
                                            Visibility(
                                              replacement: TextButton(
                                                ...
                                                onPressed: () {
                                                  ...
                                                  String ifccode = benificiarylist[index]["ifsc"];
                                                  benefid = benificiarylist[index]["id"];
                                                  deletebeneficiary(sendnum, ifccode, remid, benefid);
