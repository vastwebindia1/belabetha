...
class Paipegaspage extends StatefulWidget {
  const Paipegaspage({Key key}) : super(key: key);

  @override
  Paipegasstate createState() => Paipegasstate();
}

class Paipegasstate extends State<Paipegaspage> {
  ...
  List operatorlisr = [];
  List custparam = [];
  String Paipegasoperator = "Select Operator";
  String firsttexthint = "Consumer No";
  String accnumhint = "Agency Code";
  String accnumhint2 = "Agency Code";
  String Paipegasoptcode,duedate,rechargeamnt,customerstatus,balance;
  ...
  Future<void> Paipegasrechtask(String id, String num, String opt, String amnt, String lat,String long, String city,String address, String pin,String intype,String ipadd,String model,String key, String iv) async {
    final storage = new FlutterSecureStorage();
    var token = await storage.read(key: "accessToken");
                                        ...
                                        child: TextButton(
                                          ...
                                          onPressed: (){
                                            setState(() {
                                              ...
                                              numberenable = true;
                                              custominfolay1 = false;
                                              Paipegasoperator = operatorlisr[index]["Operatorname"];
                                              Paipegasoptcode  = operatorlisr[index]["OPtCode"];
                                              ...
                                              viewbillstatuscheck(Paipegasoptcode);
                                              Navigator.of(context).pop();
                                            });
                                          },
                                          child: Container(
  ...
  Widget build(BuildContext context) {
    return AppBarWidget(
        title: CenterAppbarTitle(
          ...
          selectedItemName:getTranslated(context, 'Paipe Gas'),
        ),
              ...
              child: Column(
                children: [
                  ...
                  Container(
                    margin: EdgeInsets.only(left: 10,right: 10),
                    child: OutlineButton(
                      onPressed:Paipegasoperatordialog,
                      ...
                      child: Container(
                        child: Row(
                          children: [
                            Expanded(child: Text(Paipegasoperator,style: TextStyle(color: PrimaryColor,fontWeight: FontWeight.normal,fontSize: 18),overflow: TextOverflow.ellipsis,)),
                              ...
                              child: Container(
                                  ...
                                  child: TextButton(
                                    ...
                                    onPressed: () {
                                      ...
                                      viewbill(consumernumber.text,Paipegasoptcode,agencycode.text);
                                    },
                                  ))
                          ),
                        ),
                        ...
                        showDialog(
                            ...
                            context) {
                              return CustomDialogWidget(
                                ...
                                description01: Paipegasoperator ,textStyle: TextStyle(fontSize: 32.0,fontWeight: FontWeight.w800),
                                ...
                                onpress2: (){
                                  ...
                                  Navigator.of(context).pop();
                                  Paipegasrechdetails(consumernumber.text,Paipegasoptcode,amount.text,lat,long,city,address,postcode,netname,ipadd,androidid);
                                },
                                onpress: (){
  ...
  void Paipegasrechdetails(String number, String operator, String amnt, String lat,String long, String city, String address,String pascode, String contype, String ipadd, String andid) async{
    ...
    Paipegasrechtask(useridd,numberr,opert,amnt,lat1,long1,city1,addre1,pascode1,cont1,ipd1,andiddd,keyencoded,viencoded);
