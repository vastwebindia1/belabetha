...
import 'package:myapp/ui/pages/dashboard/bottomNavigationPage/topTabView/topTabBarPages/tabIconPages/travelsHotelPages/flightbooking/flightbookinglist.dart';
...
class _FlightBookingState extends State<FlightBooking>with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    image1 = Image.asset('assets/pngImages/Flight.png', width: 40,);
  }
                ...
                Row(
                  children: [
                    Expanded(child: MainButton(
                      ...
                      onPressed: (){
                        Navigator.push(context, MaterialPageRoute(builder: (_) => FlightBookingList()));
                      },
                    ))
                  ],
                )
