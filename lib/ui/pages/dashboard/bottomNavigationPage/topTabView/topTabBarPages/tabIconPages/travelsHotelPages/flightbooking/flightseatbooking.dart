...
class FlightSeatBook extends StatefulWidget {
  const FlightSeatBook({Key key}) : super(key: key);

  @override
  _FlightSeatBookState createState() => _FlightSeatBookState();
}



class _FlightSeatBookState extends State<FlightSeatBook>with SingleTickerProviderStateMixin {
  bool firstTap = true;
    ...
    return Material(
      child: SimpleAppBarWidget(
          title: Align(
              ...
              child: Text("Jaipur To Delhi",style: TextStyle(color: TextColor,fontSize: 18),)),
          body: SafeArea(
                                    ...
                                    child: FlatButton(
                                      ...
                                      child:secondTap ? Row(
                                        ...
                                        children: [
                                          ...
                                          SizedBox(width: 2,),
                                          Text(
                                            "Economic Class".toUpperCase(),
                                            style: tabTextStyle2,
                                          ),
                                        ],
                                      ): Text("Economic Class".toUpperCase(),
                                          style: tabTextStyle
                                      ),
                                    ),
                                  ),
