...
class Waterbillpage extends StatefulWidget {
  const Waterbillpage({Key key}) : super(key: key);

  @override
  Waterbillpagestate createState() => Waterbillpagestate();
}
...
class Waterbillpagestate extends State<Waterbillpage> {
  ...
  var maxlen;
  String fastcode,billamnt,billduedate;
  String msz ="";
  List operatorlisr = [];
  List custparam = [];
  String wateroperator = "Select Operator";
  ...
  Future<void> waterrechtask(String id, String num, String opt, String amnt, String lat,String long, String city,String address, String pin,String intype,String ipadd,String model,String key, String iv) async {
    final storage = new FlutterSecureStorage();
    var token = await storage.read(key: "accessToken");
  ...
  Future<void> viewbill(String billnum, String optcode, String acno) async {
    ...
    if (response.statusCode == 200) {
      ...
      if(status.contains("true")){
        ...
        rechargeamnt = billinfo["billAmount"];
                                        ...
                                        child: TextButton(
                                          ...
                                          onPressed: (){
                                            setState(() {
                                              ...
                                              numberenable = true;
                                              custominfolay1 = false;
                                              wateroperator = operatorlisr[index]["Operatorname"];
                                              wateroptcode  = operatorlisr[index]["OPtCode"];
                                              ...
                                              viewbillstatuscheck(wateroptcode);
                                              Navigator.of(context).pop();
                                            });
                                          },
                                          child: Container(
  ...
  Widget build(BuildContext context) {
    return AppBarWidget(
        title: CenterAppbarTitle(
          ...
          selectedItemName:getTranslated(context, 'Water Bill'),
        ),
                  ...
                  Container(
                    ...
                    child: OutlineButton(
                      ...
                      child: Container(
                        child: Row(
                          children: [
                            Expanded(child: Text(wateroperator,style: TextStyle(color: PrimaryColor,fontWeight: FontWeight.normal,fontSize: 18),overflow: TextOverflow.ellipsis,)),
                              ...
                              child: Container(
                                  ...
                                  child: TextButton(
                                    ...
                                    onPressed: () {
                                      ...
                                      viewbill(consumernumber.text,wateroptcode,agencycode.text);
                                    },
                                  ))
                          ),
                        ),
                        ...
                        showDialog(
                            ...
                            context) {
                              return CustomDialogWidget(
                                ...
                                description01: wateroperator ,textStyle: TextStyle(fontSize: 32.0,fontWeight: FontWeight.w800),
                                ...
                                onpress2: (){
                                  ...
                                  Navigator.of(context).pop();
                                  waterrechdetails(consumernumber.text,wateroptcode,amount.text,lat,long,city,address,postcode,netname,ipadd,androidid);
                                },
                                onpress: (){
  ...
  void waterrechdetails(String number, String operator, String amnt, String lat,String long, String city, String address,String pascode, String contype, String ipadd, String andid) async{
    ...
    waterrechtask(useridd,numberr,opert,amnt,lat1,long1,city1,addre1,pascode1,cont1,ipd1,andiddd,keyencoded,viencoded);
