...
class walletsenderpage extends StatefulWidget {
  const walletsenderpage({Key key}) : super(key: key);

  @override
  _walletsenderpageState createState() => _walletsenderpageState();
}



class _walletsenderpageState extends State<walletsenderpage> {
    ...
    if (response.statusCode == 200) {
      ...
      if(status == "TXN"){
        ...
        Navigator.pushReplacement(
          context,
          PageRouteBuilder(
            pageBuilder: (context, animation1, animation2) => Upinumberregister(),
            transitionDuration: Duration(seconds: 0),
          ),);
  ...
  Widget build(BuildContext context) {
    ...
    return AppBarWidget1(
      title: CenterAppbarTitleImage(
        svgImage: 'assets/pngImages/wallet2.png',
