...
class MuncipalPage extends StatefulWidget {
  const MuncipalPage({Key key}) : super(key: key);

  @override
  Muncipalstate createState() => Muncipalstate();
}
...
class Muncipalstate extends State<MuncipalPage> {
  ...
  List operatorlisr = [];
  List custparam = [];
  String Muncipaloperator = "Select Operator";
  String firsttexthint = "Consumer No";
  String accnumhint = "Agency Code";
  String accnumhint2 = "Agency Code";
  String Muncipaloptcode,duedate,rechargeamnt,customerstatus,balance;
  ...
  Future<void> Muncipalrechtask(String id, String num, String opt, String amnt, String lat,String long, String city,String address, String pin,String intype,String ipadd,String model,String key, String iv) async {
    final storage = new FlutterSecureStorage();
    var token = await storage.read(key: "accessToken");
      ...
      if (response.statusCode == 200) {
        ...
        if(status == "Success"){
          ...
          CoolAlert.show(
              ...
              onConfirmBtnTap: (){
                Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => MuncipalPage()));},
                                        ...
                                        child: TextButton(
                                          ...
                                          onPressed: (){
                                            ...
                                            setState(() {
                                              ...
                                              numberenable = true;
                                              custominfolay1 = false;
                                              Muncipaloperator = operatorlisr[index]["Operatorname"];
                                              Muncipaloptcode  = operatorlisr[index]["OPtCode"];
                                              ...
                                              viewbillstatuscheck(Muncipaloptcode);
  ...
  void initState() {
    ...
    super.initState();
    operatorlist("Municipal Services");
  }
  ...
  Widget build(BuildContext context) {
    return AppBarWidget(
        title: CenterAppbarTitle(
          ...
          selectedItemName: viewVisible1 ? getTranslated(context, 'Municipal Taxes'): getTranslated(context, 'Municipal Service'),
        ),
              ...
              child: Column(
                children: [
                          ...
                          child: GestureDetector(
                            onTap: () {
                              ...
                              setState(() {
                                ...
                                nodatalay = false;
                                connectionerror = false;
                                firsttexthint= getTranslated(context, 'Consumer Number');
                                Muncipaloperator = "Select Operator";
                                btnvisible = false;
                                amontvisi = false;
                                numberenable = false;
                              });
                            ...
                            child: Container(
                              padding: EdgeInsets.only(
                                top: viewVisible1 ? 9 : 6,
                                bottom: viewVisible1 ? 9 : 6,
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Container(
                                    child: Flexible(
                                      child: Text(
                                          getTranslated(context, 'Municipal Service'),
                                        style: TextStyle(
                            ...
                            child: Container(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Container(
                                    child: Text(
                                        getTranslated(context, 'Municipal Taxes'),
                                      style: TextStyle(
                  ...
                  Container(
                    margin: EdgeInsets.only(left: 10,right: 10),
                    child: OutlineButton(
                      onPressed:Muncipaloperatordialog,
                      ...
                      child: Container(
                        child: Row(
                          children: [
                            Expanded(child: Text(Muncipaloperator,style: TextStyle(color: PrimaryColor,fontWeight: FontWeight.normal,fontSize: 18),overflow: TextOverflow.ellipsis,)),
                              ...
                              child: Container(
                                  ...
                                  child: TextButton(
                                    ...
                                    onPressed: () {
                                      ...
                                      viewbill(consumernumber.text,Muncipaloptcode,agencycode.text);
                                    },
                                  ))
                          ),
                        ),
                        ...
                        showDialog(
                            ...
                            context) {
                              return CustomDialogWidget(
                                ...
                                description01: Muncipaloperator ,textStyle: TextStyle(fontSize: 32.0,fontWeight: FontWeight.w800),
                                ...
                                onpress2: (){
                                  ...
                                  Navigator.of(context).pop();
                                  Muncipalrechdetails(consumernumber.text,Muncipaloptcode,amount.text,lat,long,city,address,postcode,netname,ipadd,androidid);
                                },
                                onpress: (){
  ...
  void Muncipalrechdetails(String number, String operator, String amnt, String lat,String long, String city, String address,String pascode, String contype, String ipadd, String andid) async{
    ...
    Muncipalrechtask(useridd,numberr,opert,amnt,lat1,long1,city1,addre1,pascode1,cont1,ipd1,andiddd,keyencoded,viencoded);
