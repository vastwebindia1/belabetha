...
class Broadbandpage extends StatefulWidget {
  const Broadbandpage({Key key}) : super(key: key);

  @override
  Broadbandstate createState() => Broadbandstate();
}


class Broadbandstate extends State<Broadbandpage> {
  ...
  List operatorlisr = [];
  List custparam = [];
  String Broadbandoperator = "Select Operator";
  String firsttexthint = "Consumer No";
  String accnumhint = "Agency Code";
  String accnumhint2 = "Agency Code";
  String Broadbandoptcode,duedate,rechargeamnt,customerstatus,balance;
  ...
  Future<void> Broadbandrechtask(String id, String num, String opt, String amnt, String lat,String long, String city,String address, String pin,String intype,String ipadd,String model,String key, String iv) async {
    final storage = new FlutterSecureStorage();
    var token = await storage.read(key: "accessToken");
                                        ...
                                        child: TextButton(
                                          ...
                                          onPressed: (){
                                            ...
                                            setState(() {
                                              ...
                                              numberenable = true;
                                              custominfolay1 = false;
                                              Broadbandoperator = operatorlisr[index]["Operatorname"];
                                              Broadbandoptcode  = operatorlisr[index]["OPtCode"];
                                              ...
                                              viewbillstatuscheck(Broadbandoptcode);
                                              Navigator.of(context).pop();
                                            });
                                          },
                                          child: Container(
  ...
  Widget build(BuildContext context) {
    return AppBarWidget(
        title: CenterAppbarTitle(
          ...
          selectedItemName:getTranslated(context, 'Broadband'),
        ),
              ...
              child: Column(
                children: [
                  ...
                  Container(
                    margin: EdgeInsets.only(left: 10,right: 10),
                    child: OutlineButton(
                      onPressed:Broadbandoperatordialog,
                      ...
                      child: Container(
                        child: Row(
                          children: [
                            Expanded(child: Text(Broadbandoperator,style: TextStyle(color: PrimaryColor,fontWeight: FontWeight.normal,fontSize: 18),overflow: TextOverflow.ellipsis,)),
                              ...
                              child: Container(
                                  ...
                                  child: TextButton(
                                    ...
                                    onPressed: () {
                                      ...
                                      viewbill(consumernumber.text,Broadbandoptcode,agencycode.text);
                                    },
                                  ))
                          ),
                        ),
                        ...
                        showDialog(
                            ...
                            context) {
                              return CustomDialogWidget(
                                ...
                                description01: Broadbandoperator ,textStyle: TextStyle(fontSize: 32.0,fontWeight: FontWeight.w800),
                                ...
                                onpress2: (){
                                  ...
                                  Navigator.of(context).pop();
                                  Broadbandrechdetails(consumernumber.text,Broadbandoptcode,amount.text,lat,long,city,address,postcode,netname,ipadd,androidid);
                                },
                                onpress: (){
  ...
  void Broadbandrechdetails(String number, String operator, String amnt, String lat,String long, String city, String address,String pascode, String contype, String ipadd, String andid) async{
    ...
    Broadbandrechtask(useridd,numberr,opert,amnt,lat1,long1,city1,addre1,pascode1,cont1,ipd1,andiddd,keyencoded,viencoded);
  }
...
class LeftAppBar extends StatelessWidget {
  final String topText, selectedItemName,sellName;
  const LeftAppBar({Key key, this.topText, this.selectedItemName,this.sellName,
  }) : super(key: key);
...
class CenterAppbarTitleSecond extends StatefulWidget {
  final String topText, selectedItemName;
  final pngImage;
  const CenterAppbarTitleSecond({Key key, this.topText, this.selectedItemName, this.pngImage}) : super(key: key);

  @override
  _CenterAppbarTitleSecondState createState() => _CenterAppbarTitleSecondState();
}

class _CenterAppbarTitleSecondState extends State<CenterAppbarTitleSecond> {
  @override
  Widget build(BuildContext context) {
    return Align(
        ...
        child: Row(
          ...
          children: [
            SizedBox(
                height: 25,
                width: 25,
                child: Image.asset(widget.pngImage,width: 14,color: TextColor,)
            ),
            SizedBox(width: 3,),
            Column(
              crossAxisAlignment: CrossAxisAlignment.start,
