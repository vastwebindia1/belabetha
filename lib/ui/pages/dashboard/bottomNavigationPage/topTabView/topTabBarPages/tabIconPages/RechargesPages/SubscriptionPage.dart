...
class SubscriptionState extends State<SubscriptionPage> {
  ...
  List operatorlisr = [];
  List custparam = [];
  String Subscriptionoperator = "Select Operator";
  String firsttexthint = "Consumer No";
  String accnumhint = "Agency Code";
  String accnumhint2 = "Agency Code";
  String Subscriptionoptcode,duedate,rechargeamnt,customerstatus,balance;
  ...
  Future<void> Subscriptionrechtask(String id, String num, String opt, String amnt, String lat,String long, String city,String address, String pin,String intype,String ipadd,String model,String key, String iv) async {
    final storage = new FlutterSecureStorage();
    var token = await storage.read(key: "accessToken");
  ...
  void Subscriptionoperatordialog(){
    showDialog(
                                        ...
                                        child: TextButton(
                                          ...
                                          onPressed: (){
                                            ...
                                            setState(() {
                                              ...
                                              numberenable = true;
                                              custominfolay1 = false;
                                              Subscriptionoperator = operatorlisr[index]["Operatorname"];
                                              Subscriptionoptcode  = operatorlisr[index]["OPtCode"];
                                              ...
                                              viewbillstatuscheck(Subscriptionoptcode);
  ...
  Widget build(BuildContext context) {
    return AppBarWidget(
        title: CenterAppbarTitle(
          ...
          selectedItemName:getTranslated(context, 'Subscription'),
        ),
              ...
              child: Column(
                children: [
                  ...
                  Container(
                    margin: EdgeInsets.only(left: 10,right: 10),
                    child: OutlineButton(
                      onPressed:Subscriptionoperatordialog,
                      ...
                      child: Container(
                        child: Row(
                          children: [
                            Expanded(child: Text(Subscriptionoperator,style: TextStyle(color: PrimaryColor,fontWeight: FontWeight.normal,fontSize: 18),overflow: TextOverflow.ellipsis,)),
                              ...
                              child: Container(
                                  ...
                                  child: TextButton(
                                    ...
                                    onPressed: () {
                                      ...
                                      viewbill(consumernumber.text,Subscriptionoptcode,agencycode.text);
                                    },
                                  ))
                          ),
                        ),
                        ...
                        showDialog(
                            ...
                            context) {
                              return CustomDialogWidget(
                                ...
                                description01: Subscriptionoperator ,textStyle: TextStyle(fontSize: 32.0,fontWeight: FontWeight.w800),
                                ...
                                onpress2: (){
                                  ...
                                  Navigator.of(context).pop();
                                  Subscriptionrechdetails(consumernumber.text,Subscriptionoptcode,amount.text,lat,long,city,address,postcode,netname,ipadd,androidid);
                                },
                                onpress: (){
  ...
  void Subscriptionrechdetails(String number, String operator, String amnt, String lat,String long, String city, String address,String pascode, String contype, String ipadd, String andid) async{
    ...
    Subscriptionrechtask(useridd,numberr,opert,amnt,lat1,long1,city1,addre1,pascode1,cont1,ipd1,andiddd,keyencoded,viencoded);
