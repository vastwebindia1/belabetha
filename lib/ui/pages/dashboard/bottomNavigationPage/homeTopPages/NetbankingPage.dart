...
void main() {
  runApp(netbankingpage());
}

class netbankingpage extends StatefulWidget {
  final String amount,netbnkcredit,netbnknet,mercentid,merchkey,succurl,failurl,uniqid;
  const netbankingpage({Key key, this.amount, this.netbnkcredit, this.netbnknet, this.mercentid, this.merchkey, this.succurl, this.failurl, this.uniqid}) : super(key: key);
  @override
...
class _netbankingpageState extends State<netbankingpage> {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
        debugShowCheckedModeBanner: false, home: UserInputPage(amount: widget.amount,netbnkcredit: widget.netbnkcredit,netbnknet: widget.netbnknet,succurl: widget.succurl,failurl: widget.failurl,uniqid: widget.uniqid,));
  }
}

class UserInputPage extends StatefulWidget {
  final String amount,netbnkcredit,netbnknet,succurl,failurl,uniqid;
  const UserInputPage({Key key, this.amount, this.netbnkcredit, this.netbnknet, this.succurl, this.failurl, this.uniqid}) : super(key: key);
  @override
                        ...
                        child: Column(
                          children: [
                            Container(
                              ...
                              child: Image.asset('assets/pngImages/netBanking.png'),
                            ),
                            SizedBox(height: 5,),
                            Text(getTranslated(context, 'Net Banking'),style: TextStyle(color: TextColor,fontSize: 18,),)
                          ],
                        ),
                      ),
                    ],
