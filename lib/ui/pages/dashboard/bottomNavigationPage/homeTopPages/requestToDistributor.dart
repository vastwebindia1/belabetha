...
class RequestToDistributor extends StatefulWidget {

  final String distributeramount;

  const RequestToDistributor({Key key, this.distributeramount}) : super(key: key);

  @override
  _RequestToDistributorState createState() => _RequestToDistributorState();
}
bool textButton1 = false;
class _RequestToDistributorState extends State<RequestToDistributor> {
          ...
          return Container(
            ...
            child: AlertDialog(
              ...
              title: Container(
                ...
                color: PrimaryColor,
                child: Text(
                  getTranslated(context, 'Select Distributer Bank'),
                  style: TextStyle(color: TextColor, fontSize: 22),
                ),
              ),
              content: Container(
              ...
              children: [
                ...
                Container(
                  child: Row(
                    ...
                    children: [
                      Text(getTranslated(context, 'Request to Distributor')),
                      Text(" \u{20B9} " + widget.distributeramount,style: TextStyle(fontWeight: FontWeight.bold),),
                    ],
                  ),
                ),
  ...
  void requestdealer(String mode,String collection, String comment,String retailerroll,String dealerroll) async{
    ...
    String alfa = widget.distributeramount;
