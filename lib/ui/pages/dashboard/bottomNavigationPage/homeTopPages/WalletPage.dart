...
class walletgetway extends StatefulWidget {
  final String amount,walletcredi,walletnet,mercentid,merchkey,succurl,failurl,uniqid;
  const walletgetway({Key key, this.amount, this.walletcredi, this.walletnet, this.mercentid, this.merchkey, this.succurl, this.failurl, this.uniqid}) : super(key: key);
  @override
  _walletgetwayState createState() => _walletgetwayState();
}

class _walletgetwayState extends State<walletgetway> {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
        debugShowCheckedModeBanner: false, home: UserInputPage(amount: widget.amount,walletcredi: widget.walletcredi,walletnet: widget.walletnet,succurl: widget.succurl,failurl: widget.failurl,uniqid: widget.uniqid,));
  }
}

class UserInputPage extends StatefulWidget {
  final String amount,walletcredi,walletnet,succurl,failurl,uniqid;
  const UserInputPage({Key key, this.amount, this.walletcredi, this.walletnet, this.succurl, this.failurl, this.uniqid}) : super(key: key);
  @override
                        ...
                        child: Column(
                          children: [
                            Container(
                              ...
                              child: Image.asset('assets/pngImages/wallets.png'),
                            ),
                            SizedBox(height: 5,),
                            Text(getTranslated(context, 'Wallet'),style: TextStyle(color: TextColor,fontSize: 18,),)
                          ],
                        ),
                      ),
                    ],
